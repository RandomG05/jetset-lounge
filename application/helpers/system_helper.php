 ...
 * @version   0.1
 * Copyright (c) 2018 Angga Nugraha  (https://SPOS.id)
*/
...
if(!function_exists('cek_server_backup')){
	function cek_server_backup($get_opt = array()) {
		...
		if(!empty($get_opt['as_server_backup'])){
			$r = array('success' => false, 'info' => 'Tidak dapat melakukan Transaksi, Aplikasi SPOS ini di set sebagai Server Backup!');
			die(json_encode($r));
		}
    } 
}
