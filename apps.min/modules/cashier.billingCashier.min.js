...
Ext.define("ExtApp.modules.cashier.view.billingCashier", {
    openWindow: function (me) {
        ...
        console.log("Hold Billing: ", store_billingCashier_holdBilling);
        ...
        return desktop.createWindow({
            ...
            items: [{
                ...
                items: [{
                    ...
                    fieldLabel: '',
                    name: 'customer',
                    hidden: ((me.CURR_BILL_DATA.customer_id == 0)) ? false : true,
                    items: [{
                        xtype: 'textfield',
                        name: 'customer_name',
                        fieldLabel: 'Customer',
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        xtype: 'displayfield',
                        name: 'additional_fee_rp',
                        fieldLabel: 'ADDITIONAL FEE',
                        labelSeparator: '',
                        labelWidth: 200,
                        anchor: '100%',
                        allowBlank: true,
