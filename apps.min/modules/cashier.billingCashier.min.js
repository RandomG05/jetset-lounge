...
Ext.define("ExtApp.modules.cashier.view.billingCashier", {
    openWindow: function (me) {
        ...
        var store_billingCashier_loungeBilling = theApp.getStore('billingCashier_loungeBilling', false);
        if (store_billingCashier_loungeBilling == false) {
            store_billingCashier_loungeBilling = theApp.copyStore('billing', 'store_dataBilling', 'billingCashier_loungeBilling');
        }
        ...
        store_billingCashier_loungeBilling.proxy.extraParams.billing_status = 'paid';
        store_billingCashier_loungeBilling.proxy.extraParams.is_peruser = 0;
        store_billingCashier_loungeBilling.proxy.extraParams.skip_date = 0;
        store_billingCashier_loungeBilling.proxy.extraParams.use_payment_date = 0;
        store_billingCashier_loungeBilling.proxy.extraParams.sorting_by = 'payment_date';
        store_billingCashier_loungeBilling.proxy.extraParams.use_range_date = 0;
        store_billingCashier_loungeBilling.proxy.extraParams.keywords = '';
        store_billingCashier_loungeBilling.proxy.extraParams.table_id = 1;
        store_billingCashier_loungeBilling.proxy.extraParams.limit = 25;
        ...
        store_billingCashier_paidBilling.proxy.extraParams.table_id = 2;
        ...
        me.pagingtb_loungeBilling = helperGrid.paging({
            ds: store_billingCashier_loungeBilling,
            title: 'SO Lounge'
        })
                ...
                items: [{
                    ...
                    dockedItems: [{
                        ...
                        items: [{
                            ...
                            text: 'SO<br/>CATERING',
                            cls: 'button-billing',
                            id: me.id + '_newBilling_catering_button',
                            listeners: {
                                click: function () {
                                    me.confirmCreateNewBilling(2);
                                }
                            }
                        }, {
                            xtype: 'button',
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            title: 'SO Lounge',
                            layout: 'fit',
                            id: 'tab_billingCashier_loungeBilling',
                            items: [{
                                xtype: 'gridpanel',
                                border: 0,
                                multiSelect: true,
                                id: 'grid_billingCashier_loungeBilling',
                                store: store_billingCashier_loungeBilling,
                                scroll: true,
                                columns: [{
                                    xtype: 'actioncolumn',
                                    width: 40,
                                ...
                                bbar: me.pagingtb_loungeBilling
                            }]
                        }, {
                            title: 'SO Catering',
                            layout: 'fit',
