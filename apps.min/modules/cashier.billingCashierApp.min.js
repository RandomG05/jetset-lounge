...
Ext.define("ExtApp.modules.cashier.view.billingCashierApp", {
    openWindow: function (me) {
        ...
        me.store_billingCashierAppDetail = theApp.copyStore('billing', 'store_billingDetail', 'store_billingDetail');
        me.store_billingCashierAppDetail.proxy.extraParams.billing_id = -1;
        me.store_billingCashierAppDetail.proxy.extraParams.limit = 99999;
        me.store_billingCashierAppDetail.proxy.extraParams.keywords = '';
        var selModel_billingCashierApp_billingDetail = Ext.create('Ext.selection.CheckboxModel', {
            mode: 'SIMPLE',
            listeners: {
                selectionchange: function (sm, selections) {}
            }
        });
        me.store_productCategory_billingCashierApp = theApp.getStore('store_productCategory_billingCashierApp', false);
        if (me.store_productCategory_billingCashierApp == false) {
            me.store_productCategory_billingCashierApp = theApp.copyStore('master_pos', 'store_productCategory', 'store_productCategory_billingCashierApp');
        }
        me.store_productCategory_billingCashierApp.proxy.extraParams.limit = 9999;
        me.store_productCategory_billingCashierApp.proxy.extraParams.show_all_text = 1;
        me.store_productCategory_billingCashierApp.proxy.extraParams.show_choose_text = 0;
        me.store_productCategory_billingCashierApp.proxy.extraParams.is_dropdown = 1;
        me.store_productCategory_billingCashierApp.proxy.extraParams.is_active = 1;
        me.store_productCategory_billingCashierApp.proxy.extraParams.keywords = '';
        me.store_masterProduct_billingCashierApp = theApp.getStore('store_masterProduct_billingCashierApp', false);
        if (me.store_masterProduct_billingCashierApp == false) {
            me.store_masterProduct_billingCashierApp = theApp.copyStore('cashier', 'store_masterProductCashier', 'store_masterProduct_billingCashierApp');
        }
        me.store_masterProduct_billingCashierApp.proxy.extraParams.limit = 9999999;
        me.store_masterProduct_billingCashierApp.proxy.extraParams.show_all_text = 0;
        me.store_masterProduct_billingCashierApp.proxy.extraParams.show_choose_text = 0;
        me.store_masterProduct_billingCashierApp.proxy.extraParams.is_dropdown = 0;
        me.store_masterProduct_billingCashierApp.proxy.extraParams.product_type = '';
        me.store_masterProduct_billingCashierApp.proxy.extraParams.keywords = '';
        me.store_masterProduct_billingCashierApp.proxy.extraParams.is_active = 1;
        me.store_masterProduct_billingCashierApp.proxy.extraParams.from_module = 'cashier';
        me.store_billingCashierApp_MergeBill = theApp.getStore('store_billingCashierApp_MergeBill', false);
        if (me.store_billingCashierApp_MergeBill == false) {
            me.store_billingCashierApp_MergeBill = theApp.copyStore('billing', 'store_get_dataBilling', 'store_billingCashierApp_MergeBill');
        }
        me.store_billingCashierApp_MergeBill.proxy.extraParams.billing_id = '';
        me.store_billingCashierApp_MergeBill.proxy.extraParams.limit = 99999;
        me.store_billingCashierAppDetail_split = theApp.getStore('store_billingCashierAppDetail_split', false);
        if (me.store_billingCashierAppDetail_split == false) {
            me.store_billingCashierAppDetail_split = theApp.copyStore('billing', 'store_billingDetail_split', 'store_billingCashierAppDetail_split');
        }
        me.store_billingCashierAppDetail_split.proxy.extraParams.billing_id = '';
        me.store_billingCashierAppDetail_split.proxy.extraParams.limit = 99999;
        me.store_billingCashierAppDetail_discount = theApp.getStore('store_billingCashierAppDetail_discount', false);
        if (me.store_billingCashierAppDetail_discount == false) {
            me.store_billingCashierAppDetail_discount = theApp.copyStore('billing', 'store_billingDetail_discount', 'store_billingCashierAppDetail_discount');
        }
        me.store_billingCashierAppDetail_discount.proxy.extraParams.billing_id = '';
        me.store_billingCashierAppDetail_discount.proxy.extraParams.discount_id = '';
        me.store_billingCashierAppDetail_discount.proxy.extraParams.limit = 99999;
        me.store_billingCashierAppDetail_compliment = theApp.getStore('store_billingCashierAppDetail_compliment', false);
        if (me.store_billingCashierAppDetail_compliment == false) {
            me.store_billingCashierAppDetail_compliment = theApp.copyStore('billing', 'store_billingDetail_compliment', 'store_billingCashierAppDetail_compliment');
        }
        me.store_billingCashierAppDetail_compliment.proxy.extraParams.billing_id = '';
        me.store_billingCashierAppDetail_compliment.proxy.extraParams.limit = 99999;
        if (opt_reservation_cashier == '1') {
            var hide_reservationBilling = false;
        } else {
            var hide_reservationBilling = true;
        }
        var selModel_billingCashierApp_holdBilling = Ext.create('Ext.selection.CheckboxModel', {
            mode: 'SIMPLE',
            listeners: {
                selectionchange: function (sm, selections) {
                    if (selections.length > 0) {
                        if (selections.length == 1) {
                            Ext.getCmp('billingCashierApp_MergeBill').setDisabled(true);
                            Ext.getCmp('billingCashierApp_unMergeBill').setDisabled(false);
                            Ext.getCmp('billingCashierApp_SplitBill').setDisabled(false);
                        } else {
                            Ext.getCmp('billingCashierApp_MergeBill').setDisabled(false);
                            Ext.getCmp('billingCashierApp_unMergeBill').setDisabled(true);
                            Ext.getCmp('billingCashierApp_SplitBill').setDisabled(true);
                        }
                    } else {
                        Ext.getCmp('billingCashierApp_MergeBill').setDisabled(true);
                        Ext.getCmp('billingCashierApp_unMergeBill').setDisabled(true);
        ...
        var store_billingCashierApp_holdBilling = theApp.getStore('store_billingCashierApp_holdBilling', false);
        if (store_billingCashierApp_holdBilling == false) {
            store_billingCashierApp_holdBilling = theApp.copyStore('billing', 'store_dataBilling', 'store_billingCashierApp_holdBilling');
        }
        var store_billingCashierApp_paidBilling = theApp.getStore('billingCashierApp_paidBilling', false);
        if (store_billingCashierApp_paidBilling == false) {
            store_billingCashierApp_paidBilling = theApp.copyStore('billing', 'store_dataBilling', 'billingCashierApp_paidBilling');
        }
        var store_billingCashierApp_reservationList = theApp.getStore('store_billingCashierApp_reservationList', false);
        if (store_billingCashierApp_reservationList == false) {
            store_billingCashierApp_reservationList = theApp.copyStore('reservation', 'store_reservation', 'store_billingCashierApp_reservationList');
        }
        store_billingCashierApp_holdBilling.proxy.extraParams.billing_status = 'hold';
        store_billingCashierApp_holdBilling.proxy.extraParams.is_peruser = 0;
        store_billingCashierApp_holdBilling.proxy.extraParams.skip_date = 0;
        store_billingCashierApp_holdBilling.proxy.extraParams.use_payment_date = 0;
        store_billingCashierApp_holdBilling.proxy.extraParams.sorting_by = 'updated';
        store_billingCashierApp_holdBilling.proxy.extraParams.use_range_date = 1;
        store_billingCashierApp_holdBilling.proxy.extraParams.keywords = '';
        store_billingCashierApp_paidBilling.proxy.extraParams.billing_status = 'paid';
        store_billingCashierApp_paidBilling.proxy.extraParams.is_peruser = 0;
        store_billingCashierApp_paidBilling.proxy.extraParams.skip_date = 0;
        store_billingCashierApp_paidBilling.proxy.extraParams.use_payment_date = 0;
        store_billingCashierApp_paidBilling.proxy.extraParams.sorting_by = 'payment_date';
        store_billingCashierApp_paidBilling.proxy.extraParams.use_range_date = 1;
        store_billingCashierApp_paidBilling.proxy.extraParams.keywords = '';
        store_billingCashierApp_reservationList.proxy.extraParams.not_cancel = 1;
        store_billingCashierApp_reservationList.proxy.extraParams.from_cashier = 1;
        store_billingCashierApp_reservationList.proxy.extraParams.limit = 9999;
        store_billingCashierApp_reservationList.proxy.extraParams.keywords = '';
        ...
        me.pagingtb_holdBilling = helperGrid.paging({
            ds: store_billingCashierApp_holdBilling,
            title: 'Hold Billing'
        });
        me.pagingtb_paidBilling = helperGrid.paging({
            ds: store_billingCashierApp_paidBilling,
            title: 'Paid Billing'
        });
        me.pagingtb_reservationList = helperGrid.paging({
            ds: store_billingCashierApp_reservationList,
            title: 'Reservation'
        });
        ...
        return desktop.createWindow({
            ...
            items: [{
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        border: 0,
                        multiSelect: false,
                        id: 'grid_billingCashierApp_billingDetail',
                        store: me.store_billingCashierAppDetail,
                        scroll: true,
                        selModel: selModel_billingCashierApp_billingDetail,
                        columns: [{
                            xtype: 'gridcolumn',
                            dataIndex: 'item_no',
                            hidden: true,
                        ...
                        dockedItems: [{
                            ...
                            items: [{
                                xtype: 'button',
                                name: 'deleteButton_billingCashierApp_billingDetail',
                                id: 'deleteButton_billingCashierApp_billingDetail',
                                ...
                                listeners: {
                                    click: function () {
                                        if (me.CURR_BILL_DATA.billing_status == 'paid') {
                                            ...
                                            var getSelection = Ext.getCmp('grid_billingCashierApp_billingDetail').getSelectionModel().selected;
                                            if (getSelection.length > 0) {
                                                if (getSelection.length == 1) {
                                                    ...
                                                    ExtApp.Msg.info('Select Only One Order Item!');
                                                }
                                            } else {
                                                ExtApp.Msg.info('Please Select Order Item!');
                                            }
                                        }
                                    }
                                }
                                ...
                                xtype: 'button',
                                name: 'setTableButton_billingCashierApp_billingDetail',
                                id: 'setTableButton_billingCashierApp_billingDetail',
                                text: 'SET<br/>TABLE',
                                height: 50,
                                cls: 'button-billing',
                                disabled: true,
                                listeners: {
                                    click: function () {
                                        if (me.CURR_BILL_DATA.billing_status == 'paid') {
                                            ...
                                            me.source_loadDataViewTable = 'form_billingCashierApp';
                                ...
                                xtype: 'button',
                                name: 'setGuestButton_billingCashierApp_billingDetail',
                                id: 'setGuestButton_billingCashierApp_billingDetail',
                                text: 'TOTAL<br/>GUEST',
                                height: 50,
                                cls: 'button-billing',
                                disabled: true,
                                listeners: {
                                    click: function () {
                                        if (me.CURR_BILL_DATA.billing_status == 'paid') {
                                            ...
                                            me.source_loadDataViewTotalGuest = 'form_billingCashierApp';
                                ...
                                xtype: 'button',
                                name: 'printInvoiceButton_billingCashierApp_billingDetail',
                                id: 'printInvoiceButton_billingCashierApp_billingDetail',
                        ...
                        xtype: 'panel',
                        border: 0,
                        id: 'previewArea_billingCashierApp_billingDetail',
                        layout: 'fit',
                        hidden: true,
                        items: [{
                            xtype: "component",
                            id: 'print_area_billingCashierApp',
                            autoEl: {
                                tag: "iframe",
                                src: url_report
                            },
                            ...
                            xtype: "component",
                            id: 'print_area2_billingCashierApp',
                            autoEl: {
                                tag: "iframe",
                                src: url_report
                            },
                    ...
                    dockedItems: [{
                        ...
                        items: [{
                            xtype: 'displayfield',
                            name: 'billingCashierApp_billing_no',
                            value: '',
                            fieldStyle: 'font-weight:bold; font-size:14px;',
                        }, ' | ', {
                            xtype: 'displayfield',
                            name: 'billingCashierApp_total_guest',
                            id: 'billingCashierApp_total_guest',
                            hidden: true,
                        }, {
                            xtype: 'displayfield',
                            name: 'billingCashierApp_table_id',
                            id: 'billingCashierApp_table_id',
                            hidden: true,
                        }, {
                            xtype: 'displayfield',
                            name: 'billingCashierApp_table_no',
                            id: 'billingCashierApp_table_no',
                            value: ' ',
                            fieldStyle: 'font-weight:bold; font-size:14px;',
                        }, '->', {
                            xtype: 'displayfield',
                            name: 'billingCashierApp_billing_datetime',
                            value: '',
                            fieldStyle: 'font-weight:bold; font-size:14px;',
                        }, '', {
                            xtype: 'button',
                            name: 'refreshButton_billingCashierApp_billingDetail',
                            id: 'refreshButton_billingCashierApp_billingDetail',
                            iconCls: 'btn-refresh',
                            listeners: {
                                click: function () {
                                    me.load_store_billingCashierAppDetail();
                                }
                            }
                        }, {
                            xtype: 'button',
                            name: 'lockButton_billingCashierApp',
                            id: 'lockButton_billingCashierApp',
                            iconCls: 'btn-lock',
                            hidden: true,
                            listeners: {
                                click: function () {
                            ...
                            xtype: 'button',
                            name: 'unlockButton_billingCashierApp',
                            id: 'unlockButton_billingCashierApp',
                            ...
                            xtype: 'button',
                            name: 'previewListButton_billingCashierApp',
                            id: 'previewListButton_billingCashierApp',
                            ...
                            xtype: 'button',
                            name: 'previewListButton2_billingCashierApp',
                    ...
                    items: [{
                        xtype: 'panel',
                        id: 'billingCashierApp_ProductList_area',
                        border: 0,
                        layout: 'fit',
                        ...
                        items: [{
                            ...
                            id: 'billingCashierApp_ProductList',
                            store: me.store_masterProduct_billingCashierApp,
                            loadMask: false,
                            minHeight: 300,
                            tpl: new Ext.XTemplate('<tpl for=".">', '<div class="ux-product-list" id="product-list-{id}">', '<div class="ux-product-list-icon" style="background:url({product_image_src}) center center no-repeat;">', '<img src="', Ext.BLANK_IMAGE_URL, '" title="{product_name}">', '<div class="ux-product-list-text">{product_name_show}<br/>Rp {product_price_show}</div>', '</div>', '</div>', '</tpl>', '<div class="x-clear"></div>'),
                            listeners: {
                            ...
                            itemSelector: 'div.ux-product-list',
                            overItemCls: 'product-list-over',
                            id: 'billingCashierApp_CategoryList',
                            store: me.store_productCategory_billingCashierApp,
                            loadMask: false,
                            minHeight: 300,
                            tpl: new Ext.XTemplate('<tpl for=".">', '<div class="ux-product-list" id="product-category-list-{id}">', '<div class="ux-product-list-icon">', '<div class="ux-product-list-text" style="bottom: 50px; font-size:16px;"><b>{product_category_name}</b></div>', '</div>', '</div>', '</tpl>', '<div class="x-clear"></div>'),
                            listeners: {
                                'itemclick': function (dataView, record) {
                                    Ext.getCmp("billingCashierApp_ProductList").show();
                                    Ext.getCmp("billingCashierApp_CategoryList").hide();
                                    var data_selectCategory = record.data;
                                    var getCatID = data_selectCategory.id;
                                    var store = Ext.getCmp('billingCashierApp_ProductList').store,
                                        view = Ext.getCmp('billingCashierApp_ProductList'),
                        ...
                        dockedItems: [{
                            ...
                            height: 60,
                            bodyPadding: 5,
                            id: 'billingCashierApp_ProductList_ToolbarSearch',
                            items: [{
                                text: 'DAFTAR<br/>KATEGORI',
                                width: 97,
                                height: 45,
                                textAlign: 'center',
                                cls: 'button-billing',
                                id: 'billingCashierApp_ProductList_ToolbarSearch_kategoriButton',
                                listeners: {
                                    click: function () {
                                        Ext.getCmp("billingCashierApp_ProductList").hide();
                                        Ext.getCmp("billingCashierApp_CategoryList").show();
                                    }
                                }
                            }, {
                                xtype: 'textfield',
                                ...
                                id: 'billingCashierApp_ProductList_ToolbarSearch_searchName',
                                listeners: {
                                    change: function () {
                                        me.doSearchMenu();
                                    },
                                    keyup: function () {
                                        var view = Ext.getCmp('billingCashierApp_ProductList'),
                                            selModel = view.getSelectionModel(),
                                            selection = selModel.getSelection()[0];
                                    },
                                ...
                                textAlign: 'center',
                                cls: 'button-billing',
                                id: 'billingCashierApp_ProductList_ToolbarSearch_resetButton',
                                listeners: {
                                    click: function () {
                                        Ext.getCmp("billingCashierApp_ProductList_ToolbarSearch_searchName").setValue('');
                                        me.doSearchMenu();
                                    }
                                }
                            }]
                        ...
                        xtype: 'tabpanel',
                        id: 'billingCashierApp_listBilling',
                        height: '100%',
                        activeTab: 0,
                        border: false,
                        defaults: {
                        ...
                        items: [{
                            title: 'Hold Billing',
                            layout: 'fit',
                            id: 'tab_billingCashierApp_holdBilling',
                            items: [{
                                xtype: 'gridpanel',
                                border: 0,
                                multiSelect: true,
                                id: 'grid_billingCashierApp_holdBilling',
                                store: store_billingCashierApp_holdBilling,
                                scroll: true,
                                selModel: selModel_billingCashierApp_holdBilling,
                                columns: [{
                                    xtype: 'gridcolumn',
                                    dataIndex: 'billing_id',
                                    hidden: true,
                                ...
                                listeners: {
                                    itemclick: function (view, rec, item, index, eventObj) {
                                        ExtApp.Msg.confirm('Buka Billing: ' + rec.data.billing_no + ', Table:' + rec.data.table_no, false, function (btn) {
                                            if (btn == 'yes') {
                            ...
                            title: 'Paid Billing',
                            layout: 'fit',
                            id: 'tab_billingCashierApp_paidBilling',
                            items: [{
                                xtype: 'gridpanel',
                                border: 0,
                                multiSelect: true,
                                id: 'grid_billingCashierApp_paidBilling',
                                store: store_billingCashierApp_paidBilling,
                                scroll: true,
                                columns: [{
                                    xtype: 'gridcolumn',
                                    dataIndex: 'billing_id',
                            ...
                            title: 'Reservation',
                            layout: 'fit',
                            id: 'tab_billingCashierApp_reservationList',
                            hidden: hide_reservationBilling,
                            items: [{
                                xtype: 'gridpanel',
                                border: 0,
                                multiSelect: true,
                                id: 'grid_billingCashierApp_reservationList',
                                store: store_billingCashierApp_reservationList,
                                scroll: true,
                                columns: [{
                                    xtype: 'gridcolumn',
                    ...
                    dockedItems: [{
                        ...
                        items: [{
                            ...
                            textAlign: 'center',
                            cls: 'button-billing',
                            id: 'billingCashierApp_listBillingToggleButton',
                            listeners: {
                                click: function () {
                                    me.showListBilling();
                                }
                            ...
                            xtype: 'button',
                            name: 'billingCashierApp_MergeBill',
                            id: 'billingCashierApp_MergeBill',
                            labelWidth: 70,
                            text: 'MERGE<br/>BILL',
                            height: 50,
                            cls: 'button-billing',
                            listeners: {
                                click: function () {
                                    ...
                                    var getSelection = Ext.getCmp('grid_billingCashierApp_holdBilling').getSelectionModel().selected;
                                    for (x in getSelection.items) {
                                        if (getSelection.items[x].data.table_id == '') {
                                            ExtApp.Msg.warning("Table not Set on Billing: #" + getSelection.items[x].data.billing_no + "!");
                                            return false;
                                        }
                            ...
                            xtype: 'button',
                            name: 'billingCashierApp_unMergeBill',
                            id: 'billingCashierApp_unMergeBill',
                            labelWidth: 75,
                            ...
                            listeners: {
                                click: function () {
                                    ...
                                    me.verify_unMergeBill_billingCashierApp();
                                }
                            }
                        }, {
                            xtype: 'button',
                            name: 'billingCashierApp_unMergeBill_save',
                            id: 'billingCashierApp_unMergeBill_save',
                            labelWidth: 75,
                            text: 'UNMERGE<br/>BILL',
                            height: 50,
                            cls: 'button-billing',
                            ...
                            listeners: {
                                click: function () {
                                    me.save_unMergeBill_billingCashierApp();
                                }
                            }
                        }, {
                            xtype: 'button',
                            name: 'billingCashierApp_SplitBill',
                            id: 'billingCashierApp_SplitBill',
                            labelWidth: 70,
                            text: 'SPLIT<br/>BILL',
                            height: 50,
                            cls: 'button-billing',
                            ...
                            xtype: 'button',
                            name: 'billingCashierApp_printSettlement',
                            id: 'billingCashierApp_printSettlement',
                            labelWidth: 90,
                            text: 'PRINT<br/>SETTLEMENT',
                            height: 50,
                            cls: 'button-billing',
                            listeners: {
                                click: function () {
                            ...
                            xtype: 'button',
                            name: 'billingCashierApp_SettingPrinter',
                            ...
                            cls: 'button-billing',
                            hidden: true,
                            id: 'billingCashierApp_searchMenuButton',
                            listeners: {
                                click: function () {
                                    me.showSearchMenu();
                                }
                            ...
                            text: 'REFRESH<br/>MENU',
                            width: 90,
                            height: 50,
                            textAlign: 'center',
                            cls: 'button-billing',
                            id: 'billingCashierApp_refreshMenuButton',
                            listeners: {
                                click: function () {
                                    Ext.getCmp("billingCashierApp_ProductList_ToolbarSearch_searchName").setValue('');
                                    me.doSearchMenu();
                                    var myMask = new Ext.LoadMask(Ext.getCmp('billingCashierApp_ProductList'), {
                                        msg: "Loading data Menu/Product..."
                                    });
                                    myMask.show();
                                    me.store_masterProduct_billingCashierApp.load({
                                        callback: function () {
                                            myMask.hide();
                                        }
                                    });
                                    me.store_productCategory_billingCashierApp.load();
                                }
                            }
                        }, '', {
                            ...
                            textAlign: 'center',
                            cls: 'button-billing',
                            id: 'billingCashierApp_logoutButton',
                            listeners: {
                                click: function () {
            ...
            listeners: {
                ...
                boxready: function () {
                    ...
                    var phpJs = theApp.getHelper('phpJs');
                    var EmptyData = [];
                    me.store_billingCashierAppDetail.loadData(EmptyData);
                    me.showListBilling_toggle = 0;
                    Ext.getCmp('billingCashierApp_listBilling').hide();
                    Ext.getCmp('billingCashierApp_MergeBill').hide();
                    Ext.getCmp('billingCashierApp_unMergeBill').hide();
                    Ext.getCmp('billingCashierApp_SplitBill').hide();
                    Ext.getCmp('billingCashierApp_SettingPrinter').hide();
                    Ext.getCmp('billingCashierApp_printSettlement').hide();
                    Ext.getCmp(me.id + '_cancelBilling_button').hide();
                    Ext.getCmp("grid_billingCashierApp_holdBilling").store.load();
                    if (ExtApp.asCashier == 1) {
                        Ext.getCmp(me.id + '_cancelBilling_button').show();
                        Ext.getCmp('billingCashierApp_SettingPrinter').show();
                        Ext.getCmp('billingCashierApp_printSettlement').show();
                        Ext.getCmp('tab_billingCashierApp_paidBilling').show();
                        Ext.getCmp("grid_billingCashierApp_paidBilling").store.load();
                        if (opt_reservation_cashier == '1') {
                            Ext.getCmp('tab_billingCashierApp_reservationList').show();
                            Ext.getCmp("grid_billingCashierApp_reservationList").store.load();
                        }
                    } else {
                        Ext.getCmp(me.id + '_cancelBilling_button').hide();
                        Ext.getCmp('billingCashierApp_SettingPrinter').hide();
                        Ext.getCmp('billingCashierApp_printSettlement').hide();
                        Ext.getCmp('tab_billingCashierApp_paidBilling').hide();
                        Ext.getCmp('tab_billingCashierApp_reservationList').hide();
                    }
                    me.doDisableButton(1);
                    Ext.getCmp(me.id + '_newBilling_button').setDisabled(false);
                    if (opt_hide_button_logoutaplikasi == '1') {
                        Ext.getCmp('billingCashierApp_logoutButton').hide();
                    }
                    ...
                    myMask.show();
                    var d = me.store_productCategory_billingCashierApp.getRange(0);
                    if (d.length > 0) {
                        me.store_productCategory_billingCashierApp.loadData(d);
                    } else {
                        me.store_productCategory_billingCashierApp.load();
                    }
                    var d = me.store_masterProduct_billingCashierApp.getRange(0);
                    if (d.length > 0) {
                        me.store_masterProduct_billingCashierApp.loadData(d);
                        myMask.hide();
                    } else {
                        me.store_masterProduct_billingCashierApp.load({
                            callback: function () {
                    ...
                    if (opt_hide_button_invoice == '1') {
                        Ext.getCmp('printInvoiceButton_billingCashierApp_billingDetail').hide();
                    } else {
                        Ext.getCmp('printInvoiceButton_billingCashierApp_billingDetail').show();
                    }
                }
            }
        });
    ...
    orderProduct: function (me) {
        ...
        var phpJs = theApp.getHelper('phpJs');
        me.store_productVarian_billingCashierApp = theApp.getStore('store_productVarian_billingCashierApp', false);
        if (me.store_productVarian_billingCashierApp == false) {
            me.store_productVarian_billingCashierApp = theApp.copyStore('master_pos', 'store_productVarian', 'store_productVarian_billingCashierApp');
        }
        me.store_productVarian_billingCashierApp.proxy.extraParams.limit = 9999999;
        me.store_productVarian_billingCashierApp.proxy.extraParams.show_all_text = 0;
        me.store_productVarian_billingCashierApp.proxy.extraParams.show_choose_text = 1;
        me.store_productVarian_billingCashierApp.proxy.extraParams.is_dropdown = 1;
        me.store_productVarian_billingCashierApp.proxy.extraParams.product_type = '';
        me.store_productVarian_billingCashierApp.proxy.extraParams.keywords = '';
        return desktop.createWindow({
            ...
            defaultFocus: 'order_qty_orderProduct',
            items: [{
                xtype: 'form',
                ...
                items: [{
                    ...
                    store: me.store_productVarian_billingCashierApp,
                    labelSeparator: ':',
                    labelWidth: 90,
                    width: 330,
                    height: 40,
                    ...
                    items: [{
                        ...
                        xtype: 'button',
                        width: 25,
                        id: 'btnOrderNote_payBilling',
                        iconCls: 'icon-grid-search',
                        margin: '15 0 0 10',
                        listeners: {
                            click: function () {
                                me.createWindow(me, 'orderNotePopup');
                            }
                        }
                    }, {
                        xtype: 'button',
                        width: 25,
                        id: 'btnCancelOrderNote_payBilling',
                        iconCls: 'icon-cancel',
                        margin: '15 0 0 10',
                        listeners: {
                            click: function () {
                                var form = Ext.getCmp('form_orderProduct').getForm();
                                form.findField('order_notes').setValue('');
                            }
                        }
                    }]
                }, {
                ...
                show: function () {
                    if (me.CURR_BILL_DATA.billing_status == 'paid') {
                        ...
                        if (me.formType_orderProduct == 'edit') {
                            ...
                            me.store_productVarian_billingCashierApp.proxy.extraParams.product_id = getDataProduct.product_id;
                        } else {
                            form.reset();
                            ...
                            form.findField('order_qty').setValue(1);
                            me.store_productVarian_billingCashierApp.proxy.extraParams.product_id = getDataProduct.id;
                        }
                        ...
                        if (getDataProduct.has_varian == 1) {
                            ...
                            me.store_productVarian_billingCashierApp.load({
                                callback: function () {
    ...
    printBilling: function (me) {
        ...
        var widthF__printBilling = 500;
        if (opt_print_qc_then_order == '1') {
            var widthF__printBilling = 400;
        }
        return desktop.createWindow({
            ...
            items: [{
                ...
                id: 'billingCashierApp_use_print_anywhere_printBilling',
            ...
            buttons: [{
                ...
                listeners: {
                    click: function () {
                        var use_print_anywhere = Ext.getCmp('billingCashierApp_use_print_anywhere_printBilling').getSubmitValue();
                ...
                listeners: {
                    click: function () {
                        me.orderReceipt_printBilling(1, 6000);
                    }
                }
            }, {
                ...
                text: 'CLOSE</br>PAY BILL',
                formBind: true,
                id: 'btnCancelClose_printBilling',
                width: 80,
                height: 50,
                textAlign: 'center',
                cls: 'button-billing',
                handler: function () {
                    me.doClose(me.id + '_printBilling');
                }
            }],
            listeners: {
                show: function () {
    ...
    payBilling: function (me) {
        ...
        var desktop = theApp.getDesktop();
        var phpJs = theApp.getHelper('phpJs');
        var store_masterBank_Autocomplete_billingCashierApp = theApp.getStore('store_masterBank_Autocomplete_billingCashierApp', false);
        if (store_masterBank_Autocomplete_billingCashierApp == false) {
            store_masterBank_Autocomplete_billingCashierApp = theApp.copyStore('master_pos', 'store_masterBank', 'store_masterBank_Autocomplete_billingCashierApp');
        }
        store_masterBank_Autocomplete_billingCashierApp.proxy.extraParams.payment_id = -1;
        store_masterBank_Autocomplete_billingCashierApp.proxy.extraParams.is_dropdown = 1;
        store_masterBank_Autocomplete_billingCashierApp.proxy.extraParams.limit = 9999;
        store_masterBank_Autocomplete_billingCashierApp.proxy.extraParams.keywords = '';
        var store_cashier_payment_billingCashierApp = theApp.getStore('store_cashier_payment_billingCashierApp', false);
        if (store_cashier_payment_billingCashierApp == false) {
            store_cashier_payment_billingCashierApp = theApp.copyStore('master_pos', 'store_paymentTypeCashier', 'store_cashier_payment_billingCashierApp');
        }
        if (!me.CURR_BILL_DATA.billing_no) {
            var Titletext = 'Pay Billing: #undefined';
        } else {
            var Titletext = 'Pay Billing: #' + me.CURR_BILL_DATA.billing_no_show;
        }
        ...
        return desktop.createWindow({
            ...
            defaultFocus: 'btnSave_payBilling',
            items: [{
                xtype: 'form',
                id: 'form_payBilling',
                border: 0,
                ...
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            items: [{
                                ...
                                text: 'TABLE',
                                name: 'tableButton',
                                id: 'tableButton_billingCashierApp',
                                textAlign: 'left',
                                cls: 'button-billing',
                                width: 70,
                                listeners: {
                                    click: function () {
                                        me.source_loadDataViewTable = 'form_payBilling';
                                        me.createWindow(me, 'loadDataViewTable');
                                    }
                                }
                            }, {
                                xtype: 'displayfield',
                                name: 'table_no_display',
                                fieldLabel: '',
                                value: ': -',
                                labelSeparator: '',
                                labelWidth: 5,
                        ...
                        items: [{
                            ...
                            fieldLabel: 'Payment',
                            anchor: '100%',
                            store: store_cashier_payment_billingCashierApp,
                            queryMode: 'local',
                            displayField: 'name',
                            valueField: 'name',
                            typeAhead: true,
                            ...
                            listeners: {
                                select: function (combo, records, eOpts) {
                                    ...
                                    if (records[0].data.id == 1 || records[0].data.id == 4) {
                                        ...
                                        Ext.getCmp('bank_id_payBilling').select('');
                                        Ext.getCmp('card_no_payBilling').setValue('');
                                        store_masterBank_Autocomplete_billingCashierApp.proxy.extraParams.payment_id = payment_id;
                                        store_masterBank_Autocomplete_billingCashierApp.load({
                                            callback: function () {
                            ...
                            fieldLabel: 'BANK',
                            store: store_masterBank_Autocomplete_billingCashierApp,
                            labelSeparator: ':',
                            labelWidth: 80,
                            anchor: '100%',
                            disabled: true,
                        ...
                        items: [{
                            ...
                            labelWidth: 80,
                            width: 300,
                            allowBlank: allowBlank_choose_customer,
                        }, {
                            xtype: 'button',
                            width: 30,
                        ...
                        items: [{
                            xtype: 'textfield',
                            name: 'sales_name',
                            id: 'sales_name_payBilling',
                            fieldLabel: 'Mrkt/Sales',
                            labelWidth: 80,
                            width: 300
                        }, {
                            xtype: 'button',
                            width: 30,
                            id: 'btnMarketing_payBilling',
                            iconCls: 'icon-user-data',
                            margin: '0 0 0 5',
                            listeners: {
                                click: function () {
                                    me.createWindow(me, 'marketingPopup');
                                }
                            }
                        }],
                        hidden: true
                        ...
                        items: [{
                            ...
                            items: [{
                                ...
                                xtype: 'checkbox',
                                name: 'use_print_anywhere',
                                id: 'billingCashierApp_use_print_anywhere',
                                fieldLabel: 'Use Print Anywhere?',
                                labelSeparator: ' ',
                                labelWidth: 130,
                                inputValue: '1'
                            ...
                            xtype: 'button',
                            text: 'SIMPAN NOTES',
                            name: 'saveInfoBillingButton',
                            id: 'saveInfoBilling_billingCashierApp',
                            textAlign: 'center',
                            cls: 'button-billing',
                            width: 130,
                            listeners: {
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            text: 'DISCOUNT',
                            name: 'discountButton',
                            id: 'discountButton_billingCashierApp',
                            textAlign: 'left',
                            cls: 'button-billing',
                            width: 100,
                            listeners: {
                        ...
                        items: [{
                            ...
                            text: 'TAX',
                            name: 'ppnButton',
                            id: 'ppnButton_billingCashierApp',
                            textAlign: 'left',
                            cls: 'button-billing',
                            width: 100,
                            listeners: {
                        ...
                        items: [{
                            ...
                            text: 'SERVICE',
                            name: 'serviceButton',
                            id: 'serviceButton_billingCashierApp',
                            textAlign: 'left',
                            cls: 'button-billing',
                            width: 100,
                            listeners: {
                        ...
                        items: [{
                            ...
                            id: 'complimentButton_billingCashierApp',
                            textAlign: 'left',
                            cls: 'button-billing',
                            width: 125,
                            listeners: {
                    ...
                    items: [{
                        ...
                        text: 'Rp. 0',
                        name: 'nominalButton1',
                        id: 'nominalButton1_billingCashierApp',
                        textAlign: 'center',
                        minWidth: 100,
                        height: 45,
                        margin: '0 20 0 0',
                        ...
                        listeners: {
                            click: function () {
                                ...
                                var nominalButton1_val_billingCashierApp = form.findField('nominalButton1_val_billingCashierApp').getValue();
                                if (is_compliment == 1 && payment_id != 1) {
                                    ExtApp.Msg.warning('Set Compliment hanya menggunakan Cash/Tunai!');
                                } else {
                                    form.findField('total_paid').setValue(nominalButton1_val_billingCashierApp);
                                    me.save_payBilling();
                                }
                            }
                        }
                        ...
                        text: 'Rp. 0',
                        name: 'nominalButton2',
                        id: 'nominalButton2_billingCashierApp',
                        textAlign: 'center',
                        minWidth: 100,
                        height: 45,
                        margin: '0 20 0 0',
                        ...
                        listeners: {
                            click: function () {
                                ...
                                var is_compliment = form.findField('is_compliment').getValue();
                                var payment_id = form.findField('payment_id').getValue();
                                var nominalButton2_val_billingCashierApp = form.findField('nominalButton2_val_billingCashierApp').getValue();
                                if (is_compliment == 1 && payment_id != 1) {
                                    ExtApp.Msg.warning('Set Compliment hanya menggunakan Cash/Tunai!');
                                } else {
                                    form.findField('total_paid').setValue(nominalButton2_val_billingCashierApp);
                                    me.save_payBilling();
                                }
                            }
                        }
                        ...
                        text: 'Rp. 0',
                        name: 'nominalButton3',
                        id: 'nominalButton3_billingCashierApp',
                        textAlign: 'center',
                        minWidth: 100,
                        height: 45,
                        margin: '0 20 0 0',
                        ...
                        listeners: {
                            click: function () {
                                ...
                                var is_compliment = form.findField('is_compliment').getValue();
                                var payment_id = form.findField('payment_id').getValue();
                                var nominalButton3_val_billingCashierApp = form.findField('nominalButton3_val_billingCashierApp').getValue();
                                if (is_compliment == 1 && payment_id != 1) {
                                    ExtApp.Msg.warning('Set Compliment hanya menggunakan Cash/Tunai!');
                                } else {
                                    form.findField('total_paid').setValue(nominalButton3_val_billingCashierApp);
                                    me.save_payBilling();
                                }
                            }
                        }
                        ...
                        text: 'Rp. 0',
                        name: 'nominalButton4',
                        id: 'nominalButton4_billingCashierApp',
                        textAlign: 'center',
                        minWidth: 100,
                        height: 45,
                        margin: '0 0 0 0',
                        ...
                        listeners: {
                            click: function () {
                                ...
                                var is_compliment = form.findField('is_compliment').getValue();
                                var payment_id = form.findField('payment_id').getValue();
                                var nominalButton4_val_billingCashierApp = form.findField('nominalButton4_val_billingCashierApp').getValue();
                                if (is_compliment == 1 && payment_id != 1) {
                                    ExtApp.Msg.warning('Set Compliment hanya menggunakan Cash/Tunai!');
                                } else {
                                    form.findField('total_paid').setValue(nominalButton4_val_billingCashierApp);
                                    me.save_payBilling();
                                }
                            }
                        }
                        ...
                        xtype: 'textfield',
                        hidden: true,
                        name: 'nominalButton1_val_billingCashierApp'
                    }, {
                        xtype: 'textfield',
                        hidden: true,
                        name: 'nominalButton2_val_billingCashierApp'
                    }, {
                        xtype: 'textfield',
                        hidden: true,
                        name: 'nominalButton3_val_billingCashierApp'
                    }, {
                        xtype: 'textfield',
                        hidden: true,
                        name: 'nominalButton4_val_billingCashierApp'
                    }, ]
                }]
            }],
            buttons: [{
                text: 'PRINT QC<br/>AND ORDER',
                formBind: true,
                id: 'btnPrintQC_and_Order_Receipt_payBilling',
                width: 120,
                height: 50,
                hidden: true,
                textAlign: 'center',
                ...
                listeners: {
                    click: function () {
                        var form = Ext.getCmp('form_payBilling').getForm();
                        var use_print_anywhere = form.findField('use_print_anywhere').getSubmitValue();
                        if (!use_print_anywhere) {
                            var use_print_anywhere = 0;
                        }
                        if (use_print_anywhere == 1) {
                ...
                text: 'PRINT QC<br/>RECEIPT',
                formBind: true,
                id: 'btnPrintQCReceipt_payBilling',
                width: 95,
                height: 50,
                disabled: true,
                textAlign: 'center',
                ...
                text: 'PRINT ORDER<br/>RECEIPT',
                formBind: true,
                id: 'btnPrintAllOrderReceipt_payBilling',
                width: 120,
                height: 50,
                disabled: true,
                textAlign: 'center',
                ...
                text: 'PRINT KITCHEN<br/>RECEIPT',
                formBind: true,
                id: 'btnPrintKitchenReceipt_payBilling',
                width: 135,
                height: 50,
                disabled: true,
                hidden: true,
                ...
                listeners: {
                    click: function () {
                        me.printReceipt_payBilling(3);
                    }
                }
            }, {
                text: 'PRINT BAR<br/>RECEIPT',
                formBind: true,
                id: 'btnPrintBarReceipt_payBilling',
                width: 100,
                height: 50,
                disabled: true,
                hidden: true,
                ...
                listeners: {
                    click: function () {
                        me.printReceipt_payBilling(4);
                    }
                }
            }, {
                text: 'PRINT OTHER<br/>RECEIPT',
                formBind: true,
                id: 'btnPrintOtherReceipt_payBilling',
                width: 135,
                height: 50,
                disabled: true,
                hidden: true,
                ...
                listeners: {
                    click: function () {
                        me.printReceipt_payBilling(5);
                    }
                }
            }, {
                text: 'PRINT BILL<br/>(INVOICE)',
                formBind: true,
                id: 'btnPrintReceipt_payBilling',
                width: 105,
                height: 50,
                disabled: true,
                textAlign: 'center',
                ...
                listeners: {
                    click: function () {
                        ...
                        if (use_print_anywhere == 1) {
                            ...
                            me.printReceipt_payBilling(1);
                        }
                    }
                }
            }, {
                text: 'BAYAR<br/>PRINT BILL',
                formBind: true,
                ...
                text: 'HALF PAY<br/>PRINT BILL',
                formBind: true,
                id: 'btnHalfPayment_payBilling',
                width: 105,
                height: 50,
                disabled: true,
                textAlign: 'center',
                ...
                listeners: {
                    click: function () {
                        ...
                        var is_compliment = form.findField('is_compliment').getValue();
                        if (is_compliment == 1) {
                            ExtApp.Msg.warning('Set Compliment hanya menggunakan Cash/Tunai!<br/>Tidak dapat menggunakan pembayaran sebagian (Half Payment)');
                        } else {
                            me.createWindow(me, 'setHalfPayment');
                        }
                    }
                }
            }, {
                text: 'TUTUP</br>BAYAR BILL',
                formBind: true,
                id: 'btnCancelClose_payBilling',
                width: 105,
                height: 50,
                textAlign: 'center',
                cls: 'button-billing',
                margin: '0 ' + margin_halfpaybill + ' 0 0',
                handler: function () {
                    me.doClose(me.id + '_payBilling');
                }
            }],
            listeners: {
                show: function () {
                    if (me.CURR_BILL_DATA.billing_status == 'paid') {
                        ...
                        form.findField('table_no_display').setValue(me.CURR_BILL_DATA.table_no);
    ...
    settingCashier: function (me) {
        ...
        var phpJs = theApp.getHelper('phpJs');
        var store_printerTipe_billingCashierApp = theApp.getStore('store_printerTipe_billingCashierApp', false);
        if (store_printerTipe_billingCashierApp == false) {
            store_printerTipe_billingCashierApp = theApp.copyStore('master_pos', 'store_printerTipe', 'store_printerTipe_billingCashierApp');
        }
        var store_printerPIN_billingCashierApp = theApp.getStore('store_printerPIN_billingCashierApp', false);
        if (store_printerPIN_billingCashierApp == false) {
            store_printerPIN_billingCashierApp = theApp.copyStore('master_pos', 'store_printerPIN', 'store_printerPIN_billingCashierApp');
        }
        return desktop.createWindow({
            ...
            items: [{
                ...
                id: 'tab_billingCashierApp_printerReceipt',
                items: [{
                    title: 'Cashier',
                    layout: 'fit',
                    id: 'tab_billingCashierApp_cashierReceipt',
                    items: [{
                        xtype: 'form',
                    ...
                    title: 'QC',
                    layout: 'fit',
                    id: 'tab_billingCashierApp_qcReceipt',
                    items: [{
                        xtype: 'form',
                            ...
                            items: [{
                                ...
                                items: [{
                                    ...
                                    items: [{
                                        ...
                                        name: 'printer_pin',
                                        fieldLabel: 'Length Char',
                                        store: store_printerPIN_billingCashierApp,
                                        labelSeparator: ':',
                                        labelWidth: 80,
                                        anchor: '100%',
                                    }]
                    ...
                    title: 'Kitchen',
                    layout: 'fit',
                    id: 'tab_billingCashierApp_kitchenReceipt',
                    items: [{
                        xtype: 'form',
                    ...
                    title: 'Bar',
                    layout: 'fit',
                    id: 'tab_billingCashierApp_barReceipt',
                    items: [{
                        xtype: 'form',
                    ...
                    title: 'Other',
                    layout: 'fit',
                    id: 'tab_billingCashierApp_otherReceipt',
                    items: [{
                        xtype: 'form',
    ...
    loadDataViewTable: function (me) {
        var theApp = me.app;
        var desktop = theApp.getDesktop();
        var Titletext = 'Choose Available Table ';
        var phpJs = theApp.getHelper('phpJs');
        var from_source = me.source_loadDataViewTable;
        if (!me.CURR_BILL_DATA.block_table) {
            me.CURR_BILL_DATA.block_table = 0;
        }
        var store_tableFloorPlan = theApp.getStore('store_tableFloorPlan', false);
        if (store_tableFloorPlan == false) {
            store_tableFloorPlan = theApp.copyStore('master_pos', 'store_masterFloorplan', 'store_tableFloorPlan');
        }
        ...
        me.store_billingCashierApp_blockTable = theApp.getStore('store_billingCashierApp_blockTable', false);
        if (me.store_billingCashierApp_blockTable == false) {
            me.store_billingCashierApp_blockTable = theApp.copyStore('master_pos', 'store_masterTableInv', 'store_billingCashierApp_blockTable');
        }
        me.store_billingCashierApp_blockTable.proxy.extraParams.limit = 9999;
        me.store_billingCashierApp_blockTable.proxy.extraParams.show_available = 0;
        me.store_billingCashierApp_blockTable.proxy.extraParams.show_selected = 1;
        me.store_billingCashierApp_blockTable.proxy.extraParams.curr_billing = me.CURR_BILL_DATA.billing_id;
        me.store_billingCashierApp_blockTable.proxy.extraParams.keywords = '';
        var selModel_billingCashierApp_blockTable = Ext.create('Ext.selection.CheckboxModel', {
            listeners: {
                selectionchange: function (sm, selections) {
                    Ext.getCmp('grid_billingCashierApp_blockTable').down('#deleteButton_billingCashierApp_blockTable').setDisabled(selections.length == 0);
                    Ext.getCmp('grid_billingCashierApp_blockTable').down('#setDefaultButton_billingCashierApp_blockTable').setDisabled(selections.length == 0);
                }
            }
        });
        ...
        return desktop.createWindow({
            ...
            items: [{
                ...
                items: [{
                    ...
                    flex: 1.8,
                    region: 'center',
                    id: 'billingCashierApp_dataViewTable_area',
                    border: 0,
                    width: 540,
                    layout: 'fit',
                    bodyStyle: 'background:url(' + appUrl + 'assets/desktop/wallpapers/wall_preferences.jpg) center center;',
                    items: [{
                        ...
                        itemSelector: 'div.ux-product-list',
                        overItemCls: 'product-list-over',
                        id: 'billingCashierApp_dataViewTable',
                        store: store_dataViewTable,
                        minHeight: 300,
                        tpl: new Ext.XTemplate('<tpl for=".">', '<div class="ux-product-list list-dttable" id="dvTable-list-{id}">', '<div class="ux-product-list-icon list-dttable">', '<div class="ux-product-list-text list-dttable">{table_no}</div>', '<div style="font-size:9px;color:#ccc;top:45px;left:0px;position:absolute; width:153px;">{kapasitas_text}</div>', '</div>', '</div>', '</tpl>', '<div class="x-clear"></div>'),
                        listeners: {
                            'itemclick': function (dataView, record) {
                                ...
                                if (me.CURR_BILL_DATA.block_table == 1) {
                                    var d = me.store_billingCashierApp_blockTable.getRange(0);
                                    if (d.length == 0) {
                                        set_table_form = true;
                                    } else {
                                ...
                                if (set_table_form == true) {
                                    if (from_source == 'form_payBilling') {
                                        ...
                                        var form2 = Ext.getCmp('form_billingCashierApp').getForm();
                                        form2.findField('billingCashierApp_table_id').setValue(getDataTable.id);
                                        form2.findField('billingCashierApp_table_no').setValue(getDataTable.table_no);
                                    ...
                                    if (from_source == 'form_billingCashierApp') {
                                        var form = Ext.getCmp('form_billingCashierApp').getForm();
                                        form.findField('billingCashierApp_table_id').setValue(getDataTable.id);
                                        form.findField('billingCashierApp_table_no').setValue(getDataTable.table_no);
                                        if (getDataTable.table_tipe == 'takeaway') {
                                            me.updateTableBilling(is_block_table, getDataTable, 1);
                                        } else {
                                            me.updateTableBilling(is_block_table, getDataTable, 0);
                                        ...
                                        form.findField('billingCashierApp_table_no').setValue('');
                                    }
                                    if (me.CURR_BILL_DATA.block_table == 0) {
                                        Ext.getCmp("billingCashierApp_dataViewTable_ToolbarSearch_searchName").setValue('');
                                        me.doSearchTable();
                                    }
                                }
                                if (is_block_table == 0) {
                    ...
                    xtype: 'panel',
                    id: 'billingCashierApp_blockTable_area',
                    flex: 1,
                    region: 'east',
                    bodyPadding: 0,
                    border: 0,
                    ...
                    items: [{
                        xtype: 'gridpanel',
                        border: 0,
                        id: 'grid_billingCashierApp_blockTable',
                        store: me.store_billingCashierApp_blockTable,
                        scroll: true,
                        selModel: selModel_billingCashierApp_blockTable,
                        columns: [{
                            xtype: 'gridcolumn',
                            dataIndex: 'id',
                            hidden: true,
                        ...
                        dockedItems: [{
                            ...
                            items: [{
                                text: 'Hapus',
                                itemId: 'deleteButton_billingCashierApp_blockTable',
                                tooltip: 'Hapus Block table',
                                iconCls: 'btn-delete',
                                disabled: true,
                                listeners: {
                                    click: function () {
                                        var getSelection = Ext.getCmp('grid_billingCashierApp_blockTable').getSelectionModel().selected;
                                        if (getSelection.length > 0) {
                                            me.delete_data_blockTable = getSelection.items[0].data;
                                            me.deleteTableBilling();
                                        } else {
                                            ExtApp.Msg.info('Please Pilih Table/Meja!');
                                        }
                                    }
                                }
                            }, {
                                text: 'Set Default',
                                itemId: 'setDefaultButton_billingCashierApp_blockTable',
                                ...
                                text: 'Refresh',
                                itemId: 'refreshButton_billingCashierApp_blockTable',
                                tooltip: 'Refresh Block table',
                                iconCls: 'btn-refresh',
                                listeners: {
                                    click: function () {
                                        Ext.getCmp('grid_billingCashierApp_blockTable').store.load();
                                    }
                                }
                            }]
                        }]
            ...
            buttons: [{
                ...
                id: 'billingCashierApp_dataViewTable_ToolbarSearch_searchName',
                listeners: {
                    change: function () {
                        me.doSearchTable();
                    },
                    keyup: function () {
                        var view = Ext.getCmp('billingCashierApp_dataViewTable'),
                            selModel = view.getSelectionModel(),
                            selection = selModel.getSelection()[0];
                    },
                    specialkey: function (field, e) {
                ...
                textAlign: 'center',
                cls: 'button-category',
                id: 'billingCashierApp_dataViewTable_ToolbarSearch_resetButton',
                margin: '0 15 0 0',
                listeners: {
                    click: function () {
                        Ext.getCmp("billingCashierApp_dataViewTable_ToolbarSearch_searchName").setValue('');
                ...
                id: 'billingCashierApp_setBlockTable',
                width: 150,
                height: 30,
                hidden: true,
                textAlign: 'center',
                ...
                handler: function () {
                    ...
                    Ext.getCmp('billingCashierApp_setBlockTable').hide();
                    Ext.getCmp('billingCashierApp_clearBlockTable').show();
                    Ext.getCmp('billingCashierApp_blockTable_area').setDisabled(false);
                }
            }, {
                text: 'Clear Block Table',
                id: 'billingCashierApp_clearBlockTable',
                width: 150,
                height: 30,
                hidden: true,
                textAlign: 'center',
                ...
                handler: function () {
                    me.CURR_BILL_DATA.block_table = 0;
                    Ext.getCmp('billingCashierApp_clearBlockTable').hide();
                    Ext.getCmp('billingCashierApp_setBlockTable').show();
                    Ext.getCmp('billingCashierApp_blockTable_area').setDisabled(true);
                }
            }, {
                text: 'Close',
                width: 80,
            ...
            listeners: {
                show: function () {
                    store_dataViewTable.load();
                    me.store_billingCashierApp_blockTable.load();
                    if (me.CURR_BILL_DATA.block_table == 1) {
                        Ext.getCmp('billingCashierApp_setBlockTable').hide();
                        Ext.getCmp('billingCashierApp_clearBlockTable').show();
                        Ext.getCmp('billingCashierApp_blockTable_area').setDisabled(false);
                ...
                boxready: function () {
                    ...
                    var buttonItem = {
                        ...
                        listeners: {
                            click: function () {
                                var store = Ext.getCmp('billingCashierApp_dataViewTable').store,
                                    view = Ext.getCmp('billingCashierApp_dataViewTable'),
                                    selModel = view.getSelectionModel(),
                                    selection = selModel.getSelection()[0];
                                store.suspendEvents();
                                store.clearFilter();
                    ...
                    var getCatTotal = store_tableFloorPlan.getCount();
                    if (getCatTotal == 0) {
                        store_tableFloorPlan.load({
                            callback: function (records, operation, success) {
                                ...
                                Ext.getCmp('billingCashierApp_dataViewTable_area').addDocked(dockTopCashier);
                            }
                        });
                    } else {
                        var records = store_tableFloorPlan.data.items;
                        for (x in records) {
                            buttonItem = {
                                xtype: 'button',
                                height: 35,
    ...
    loadDataViewTotalGuest: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_changeTotalGuest_billingCashierApp',
                width: 300,
                border: false,
                bodyBorder: false,
                items: [{
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnChange_changeTotalGuest_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.save_changeTotalGuest_billingCashierApp(from_source);
                }
            }, {
                text: 'Cancel',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_changeTotalGuest_billingCashierApp',
                margin: '0 60 0 0',
                handler: function () {
            ...
            listeners: {
                show: function () {
                    ...
                    var form2 = Ext.getCmp('form_changeTotalGuest_billingCashierApp').getForm();
                    form2.reset();
    ...
    changePPN: function (me) {
        var theApp = me.app;
        var desktop = theApp.getDesktop();
        var Titletext = 'Change PPN - PB1';
        var phpJs = theApp.getHelper('phpJs');
        return desktop.createWindow({
            id: me.id + '_changePPN',
            title: 'Change PPN - PB1',
            width: 300,
            iconCls: 'icon-money',
            animCollapse: false,
            constrainHeader: true,
            ...
            items: [{
                xtype: 'form',
                id: 'form_changePPN_billingCashierApp',
                width: 300,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        ...
                        listeners: {
                            specialkey: function (field, e) {
                                if (e.getKey() == e.ENTER) {
                                    me.verify_changePPN_billingCashierApp();
                                }
                            }
                        }
                    }, {
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnChange_changePPN_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_changePPN_billingCashierApp();
                }
                ...
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_changePPN_billingCashierApp',
                margin: '0 60 0 0',
                handler: function () {
                ...
                listeners: {
                    click: function () {
                        me.save_changePPN_billingCashierApp();
                    }
                }
            }],
            listeners: {
                show: function () {
                    ...
                    var form2 = Ext.getCmp('form_changePPN_billingCashierApp').getForm();
                    form2.reset();
    ...
    changeService: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_changeService_billingCashierApp',
                width: 300,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        ...
                        listeners: {
                            specialkey: function (field, e) {
                                if (e.getKey() == e.ENTER) {
                                    me.verify_changeService_billingCashierApp();
                                }
                            }
                        }
                    }, {
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnChange_changeService_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_changeService_billingCashierApp();
                }
                ...
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_changeService_billingCashierApp',
                margin: '0 60 0 0',
                handler: function () {
                ...
                listeners: {
                    click: function () {
                        me.save_changeService_billingCashierApp();
                    }
                }
            }],
            listeners: {
                show: function () {
                    ...
                    var form2 = Ext.getCmp('form_changeService_billingCashierApp').getForm();
                    form2.reset();
    ...
    changeDP: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_changeDP_billingCashierApp',
                width: 300,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        ...
                        listeners: {
                            specialkey: function (field, e) {
                                if (e.getKey() == e.ENTER) {
                                    me.verify_changeDP_billingCashierApp();
                                }
                            }
                        }
                    }, {
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnChange_changeDP_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.save_changeDP_billingCashierApp();
                }
            }, {
                text: 'Cancel',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_changeDP_billingCashierApp',
                margin: '0 60 0 0',
                handler: function () {
            ...
            listeners: {
                show: function () {
                    ...
                    var form2 = Ext.getCmp('form_changeDP_billingCashierApp').getForm();
                    form2.reset();
    ...
    setDiscountBilling: function (me) {
        var theApp = me.app;
        var desktop = theApp.getDesktop();
        var Titletext = 'Choose Set Discount';
        var phpJs = theApp.getHelper('phpJs');
        me.store_discountPlanner_perBilling_billingCashierApp = theApp.getStore('store_discountPlanner_perBilling_billingCashierApp', false);
        if (me.store_discountPlanner_perBilling_billingCashierApp == false) {
            me.store_discountPlanner_perBilling_billingCashierApp = theApp.copyStore('master_pos', 'store_discountPlanner', 'store_discountPlanner_perBilling_billingCashierApp');
        }
        me.store_discountPlanner_perBilling_billingCashierApp.proxy.extraParams.is_dropdown = 1;
        me.store_discountPlanner_perBilling_billingCashierApp.proxy.extraParams.show_valid_date = 1;
        me.store_discountPlanner_perBilling_billingCashierApp.proxy.extraParams.is_discBilling = 1;
        me.store_discountPlanner_perBilling_billingCashierApp.proxy.extraParams.keywords = '';
        return desktop.createWindow({
            id: me.id + '_setDiscountBilling',
            title: 'Select Discount/Voucher Per-Billing',
            width: 520,
            height: 230,
            iconCls: 'icon-money',
            animCollapse: false,
            ...
            items: [{
                xtype: 'form',
                id: 'form_setDiscount_perBilling_billingCashierApp',
                width: 520,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            text: 'Verify',
                            iconCls: 'btn-refresh',
                            id: 'btnVerifyVoucher_setDiscount_perBilling_billingCashierApp',
                            margin: '0 40 0 0',
                            handler: function () {
                                me.verify_voucher_setDiscount_perBilling_billingCashierApp();
                            }
                        }]
                    }, {
                        xtype: 'combobox',
                        name: 'discount_name',
                        id: 'discount_name_setDiscount_perBilling_billingCashierApp',
                        fieldLabel: 'Discount',
                        store: me.store_discountPlanner_perBilling_billingCashierApp,
                        labelSeparator: ':',
                        width: 400,
                        labelWidth: 110,
                        margin: "0 0 10 0",
                        ...
                        listeners: {
                            select: function (combo, records, eOpts) {
                                var form2 = Ext.getCmp('form_setDiscount_perBilling_billingCashierApp').getForm();
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'icon-grid',
                id: 'btnSet_setDiscount_perItem_onPerBilling_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSet_setDiscount_perBilling_onPerBilling_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_setDiscount_perBilling_billingCashierApp();
                }
            }, {
                text: 'Clear Discount',
                formBind: true,
                iconCls: 'btn-clear',
                id: 'btnSet_clearDiscount_perBilling_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_setDiscount_perBilling_billingCashierApp(1);
                }
            }, {
                text: 'Close',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_setDiscount_perBilling_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.doClose(me.id + '_setDiscountBilling');
                }
            ...
            listeners: {
                show: function () {
                    ...
                    me.store_discountPlanner_perBilling_billingCashierApp.load({
                        callback: function () {
                            if (me.CURR_BILL_DATA.discount_perbilling == 1) {
                                Ext.getCmp('discount_name_setDiscount_perBilling_billingCashierApp').select(me.CURR_BILL_DATA.discount_notes);
                            }
                        }
                    });
                }
    ...
    setDiscount: function (me) {
        ...
        var phpJs = theApp.getHelper('phpJs');
        me.store_discountPlanner_perItem_billingCashierApp = theApp.getStore('store_discountPlanner_perItem_billingCashierApp', false);
        if (me.store_discountPlanner_perItem_billingCashierApp == false) {
            me.store_discountPlanner_perItem_billingCashierApp = theApp.copyStore('master_pos', 'store_discountPlanner', 'store_discountPlanner_perItem_billingCashierApp');
        }
        me.store_discountPlanner_perItem_billingCashierApp.proxy.extraParams.is_dropdown = 1;
        me.store_discountPlanner_perItem_billingCashierApp.proxy.extraParams.show_valid_date = 1;
        me.store_discountPlanner_perItem_billingCashierApp.proxy.extraParams.is_discBilling = 0;
        me.store_discountPlanner_perItem_billingCashierApp.proxy.extraParams.keywords = '';
        var selModel_billingCashierApp_billingDetail_discount = Ext.create('Ext.selection.CheckboxModel', {
            mode: 'SIMPLE',
            listeners: {
                selectionchange: function (sm, selections) {}
            }
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_setDiscount_billingCashierApp',
                width: 450,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            text: 'Verify',
                            iconCls: 'btn-refresh',
                            id: 'btnVerifyVoucher_setDiscount_perItem_billingCashierApp',
                            margin: '0 40 0 0',
                            handler: function () {
                                me.verify_voucher_setDiscount_perItem_billingCashierApp();
                            }
                        }, {
                            xtype: 'combobox',
                            name: 'discount_name',
                            id: 'discount_name_setDiscount_billingCashierApp',
                            fieldLabel: 'Discount',
                            store: me.store_discountPlanner_perItem_billingCashierApp,
                            labelSeparator: ':',
                            width: 345,
                            labelWidth: 60,
                            margin: "0 0 10 0",
                            ...
                            listeners: {
                                select: function (combo, records, eOpts) {
                                    var form2 = Ext.getCmp('form_setDiscount_billingCashierApp').getForm();
                                    form2.findField('discount_id').setValue(records[0].data.id);
                                    form2.findField('discount_notes').setValue(records[0].data.discount_name);
                                    form2.findField('discount_percentage').setValue(records[0].data.discount_percentage);
                                    form2.findField('discount_price').setValue(records[0].data.discount_price);
                                    form2.findField('min_total_billing').setValue(records[0].data.min_total_billing);
                                    form2.findField('discount_max_price').setValue(records[0].data.discount_max_price);
                                    me.store_billingCashierAppDetail_discount.proxy.extraParams.discount_id = records[0].data.id;
                                    me.store_billingCashierAppDetail_discount.proxy.extraParams.billing_id = me.CURR_BILL_DATA.billing_id;
                                    me.store_billingCashierAppDetail_discount.load();
                                }
                            }
                        }]
                    }, {
                        ...
                        items: [{
                            ...
                            border: 0,
                            multiSelect: true,
                            id: 'grid_billingCashierApp_billingDetail_discount',
                            store: me.store_billingCashierAppDetail_discount,
                            scroll: true,
                            selModel: selModel_billingCashierApp_billingDetail_discount,
                            columns: [{
                                xtype: 'gridcolumn',
                                dataIndex: 'item_no',
                                hidden: true,
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-refresh',
                id: 'btnSet_refreshDiscount_perItem_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    var form = Ext.getCmp('form_payBilling').getForm();
                    ...
                    me.store_billingCashierAppDetail_discount.proxy.extraParams.discount_id = discount_id_old;
                    me.store_billingCashierAppDetail_discount.load();
                }
            }, {
                text: 'Apply Discount',
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSet_setDiscount_perItem_onPerItem_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_setDiscount_billingCashierApp();
                }
            }, {
                text: 'Discount Per-Billing',
                formBind: true,
                iconCls: 'icon-grid',
                id: 'btnSet_setDiscount_perBilling_onPerItem_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                ...
                formBind: true,
                iconCls: 'btn-clear',
                id: 'btnSet_clearDiscount_perItem_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_setDiscount_billingCashierApp(1);
                }
            }, {
                text: 'Close',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_setDiscount_perItem_billingCashierApp',
                margin: '0 60 0 0',
                handler: function () {
                    me.doClose(me.id + '_setDiscount');
                }
            ...
            listeners: {
                show: function () {
                    ...
                    me.store_billingCashierAppDetail_discount.proxy.extraParams.discount_id = 0;
                    me.store_billingCashierAppDetail_discount.proxy.extraParams.billing_id = me.CURR_BILL_DATA.billing_id;
                    me.store_billingCashierAppDetail_discount.load();
                    me.store_discountPlanner_perItem_billingCashierApp.load({
                        callback: function () {
                            Ext.getCmp('discount_name_setDiscount_billingCashierApp').select(me.CURR_BILL_DATA.discount_notes);
                        }
                    });
                }
            }
    ...
    setCompliment: function (me) {
        ...
        var phpJs = theApp.getHelper('phpJs');
        var selModel_billingCashierApp_billingDetail_compliment = Ext.create('Ext.selection.CheckboxModel', {
            mode: 'SIMPLE',
            listeners: {
                selectionchange: function (sm, selections) {}
            }
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_setCompliment_billingCashierApp',
                width: 450,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            border: 0,
                            multiSelect: true,
                            id: 'grid_billingCashierApp_billingDetail_compliment',
                            store: me.store_billingCashierAppDetail_compliment,
                            scroll: true,
                            selModel: selModel_billingCashierApp_billingDetail_compliment,
                            columns: [{
                                xtype: 'gridcolumn',
                                dataIndex: 'item_no',
                                hidden: true,
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-refresh',
                id: 'btnSet_refreshCompliment_perItem_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.store_billingCashierAppDetail_compliment.load();
                }
            }, {
                text: 'Set Compliment / Item',
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSet_setCompliment_perItem_onPerItem_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_setCompliment_billingCashierApp();
                }
            }, {
                text: 'Save',
                formBind: true,
                ...
                listeners: {
                    click: function () {
                        me.save_setCompliment_billingCashierApp();
                    }
                }
            }, {
                text: 'Clear',
                ...
                listeners: {
                    click: function () {
                        me.save_setCompliment_billingCashierApp(1);
                    }
                }
            }, {
                text: 'Clear Compliment',
                formBind: true,
                iconCls: 'btn-clear',
                id: 'btnSet_clearCompliment_perItem_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.verify_setCompliment_billingCashierApp(1);
                }
            }, {
                text: 'Close',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_setCompliment_perItem_billingCashierApp',
                margin: '0 120 0 0',
                handler: function () {
            ...
            listeners: {
                show: function () {
                    me.store_billingCashierAppDetail_compliment.proxy.extraParams.billing_id = me.CURR_BILL_DATA.billing_id;
                    me.store_billingCashierAppDetail_compliment.load();
                }
            }
        });
    ...
    setHalfPayment: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_halfPayment_billingCashierApp',
                width: 350,
                width: 180,
                border: false,
                bodyBorder: false,
                    ...
                    items: [{
                        ...
                        listeners: {
                            blur: function (field, e) {
                                var form = Ext.getCmp('form_payBilling').getForm();
                                var form2 = Ext.getCmp('form_halfPayment_billingCashierApp').getForm();
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSave_halfPayment_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.save_halfPayment_billingCashierApp();
                }
            }, {
                text: 'Cancel',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_halfPayment_billingCashierApp',
                margin: '0 60 0 0',
                handler: function () {
                    var form = Ext.getCmp('form_payBilling').getForm();
    ...
    setCancelOrder: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_setCancelOrder_billingCashierApp',
                width: 450,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        xtype: 'displayfield',
                        name: 'product_name',
                        id: 'product_name_setCancelOrder_billingCashierApp',
                        fieldLabel: 'Product',
                        labelSeparator: ':',
                        labelWidth: 90,
                        anchor: '100%',
                        ...
                        xtype: 'displayfield',
                        name: 'order_qty',
                        id: 'qtyMax_setCancelOrder_billingCashierApp',
                        fieldLabel: 'Qty Order',
                        labelSeparator: ':',
                        labelWidth: 90,
                        anchor: '100%',
                        ...
                        id: 'qty_setCancelOrder_billingCashierApp',
                        ...
                        id: 'keterangan_setCancelOrder_billingCashierApp',
                        fieldLabel: 'Notes',
                        labelSeparator: ':',
                        labelWidth: 90,
                        width: 320,
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSet_setCancelOrder_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.cancelOrder_keterangan = Ext.getCmp('keterangan_setCancelOrder_billingCashierApp').getValue();
                    me.cancelOrder_qty = Ext.getCmp('qty_setCancelOrder_billingCashierApp').getValue();
                ...
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_setCancelOrder_billingCashierApp',
                margin: '0 50 0 0',
                handler: function () {
                    me.doClose(me.id + '_setCancelOrder');
                }
            ...
            listeners: {
                show: function () {
                    Ext.getCmp('keterangan_setCancelOrder_billingCashierApp').setValue('');
                    Ext.getCmp('qtyMax_setCancelOrder_billingCashierApp').setValue(me.deleteOrderData.order_qty);
                    Ext.getCmp('product_name_setCancelOrder_billingCashierApp').setValue(me.deleteOrderData.product_name);
                    if (me.deleteOrderData.order_status == 'done') {
                        Ext.getCmp('qty_setCancelOrder_billingCashierApp').setValue(1);
                        Ext.getCmp('qty_setCancelOrder_billingCashierApp').show();
                    } else {
                        Ext.getCmp('qty_setCancelOrder_billingCashierApp').setValue(me.deleteOrderData.order_qty);
                        Ext.getCmp('qty_setCancelOrder_billingCashierApp').hide();
                    }
                }
            }
        });
    ...
    setCancelBilling: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_setCancelBilling_billingCashierApp',
                width: 450,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        xtype: 'hidden',
                        name: 'billing_id',
                        id: 'billing_id_setCancelBilling_billingCashierApp'
                    }, {
                        xtype: 'hidden',
                        name: 'qty_done',
                        id: 'qty_done_setCancelBilling_billingCashierApp'
                    }, {
                        xtype: 'displayfield',
                        name: 'billing_no',
                        id: 'billing_no_setCancelBilling_billingCashierApp',
                        fieldLabel: 'Billing',
                        labelSeparator: ':',
                        labelWidth: 90,
                        anchor: '100%',
                        ...
                        id: 'keterangan_setCancelBilling_billingCashierApp',
                        fieldLabel: 'Notes',
                        labelSeparator: ':',
                        labelWidth: 90,
                        width: 320,
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSet_setCancelBilling_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.cancelBilling_billing_id = Ext.getCmp('billing_id_setCancelBilling_billingCashierApp').getValue();
                    me.cancelBilling_billing_no = Ext.getCmp('billing_no_setCancelBilling_billingCashierApp').getValue();
                    me.cancelBilling_keterangan = Ext.getCmp('keterangan_setCancelBilling_billingCashierApp').getValue();
                    me.cancelBilling_qty_done = Ext.getCmp('qty_done_setCancelBilling_billingCashierApp').getValue();
                    if (me.cancelBilling_keterangan == '') {
                ...
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_setCancelBilling_billingCashierApp',
                margin: '0 50 0 0',
                handler: function () {
                    me.doClose(me.id + '_setCancelBilling');
                }
            ...
            listeners: {
                show: function () {
                    var getDataBilling = me.CURR_BILL_DATA;
                    Ext.getCmp('keterangan_setCancelBilling_billingCashierApp').setValue('');
                    Ext.getCmp('billing_id_setCancelBilling_billingCashierApp').setValue(getDataBilling.billing_id);
                    Ext.getCmp('billing_no_setCancelBilling_billingCashierApp').setValue(getDataBilling.billing_no);
                    var getDeliver = 0;
                    var d = Ext.getCmp('grid_billingCashierApp_billingDetail').store.getRange(0);
                    if (d.length > 0) {
                        for (x in d) {
                    ...
                    Ext.getCmp('qty_done_setCancelBilling_billingCashierApp').setValue(getDeliver);
                }
            }
        });
    },
    mergeBill: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'form',
                id: 'form_mergeBill_billingCashierApp',
                width: 300,
                border: false,
                bodyBorder: false,
                items: [{
                    ...
                    items: [{
                        ...
                        store: me.store_billingCashierApp_MergeBill,
                        labelSeparator: ':',
                        labelWidth: 80,
                        anchor: '100%',
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSave_mergeBill_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.save_mergeBill_billingCashierApp();
                }
            }, {
                text: 'Cancel',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_mergeBill_billingCashierApp',
                margin: '0 15 0 0',
                handler: function () {
            ...
            listeners: {
                show: function () {
                    ...
                    me.clearBilling();
                    me.store_billingCashierApp_MergeBill.proxy.extraParams.billing_status = 'hold';
                    me.store_billingCashierApp_MergeBill.proxy.extraParams.skip_date = 1;
                    me.store_billingCashierApp_MergeBill.proxy.extraParams.is_dropdown = 1;
                    me.store_billingCashierApp_MergeBill.proxy.extraParams.merge_bill_id = merge_var.allID;
                    me.store_billingCashierApp_MergeBill.load();
                }
            }
        });
    },
    splitBill: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                ...
                border: 0,
                multiSelect: true,
                id: 'grid_billingCashierApp_billingDetail_split',
                store: me.store_billingCashierAppDetail_split,
                scroll: true,
                columns: [{
                    xtype: 'gridcolumn',
                    dataIndex: 'item_no',
            ...
            buttons: [{
                ...
                formBind: true,
                iconCls: 'btn-save',
                id: 'btnSave_splitBill_billingCashierApp',
                margin: '0 10 0 0',
                handler: function () {
                    me.save_splitBill_billingCashierApp();
                }
            }, {
                text: 'Cancel',
                formBind: true,
                iconCls: 'btn-cancel',
                id: 'btnCancel_splitBill_billingCashierApp',
                margin: '0 15 0 0',
                handler: function () {
            ...
            listeners: {
                show: function () {
                    if (!me.data_split_id) {
                        me.doClose(me.id + '_splitBill');
                        ExtApp.Msg.warning("Tidak dapat melakukan Split Billing, select billing first!");
                        return false;
                    }
                    Ext.getCmp('btnSave_splitBill_billingCashierApp').setDisabled(true);
                    me.clearBilling();
                    var d = new Date();
                    Ext.Ajax.request({
                        waitMsg: 'Loading...',
                        ...
                        success: function (response, options) {
                            ...
                            if (rsp.success == false) {
                                ...
                                Ext.getCmp('btnSave_splitBill_billingCashierApp').setDisabled(false);
                                me.store_billingCashierAppDetail_split.proxy.extraParams.billing_id = me.data_split_id;
                                me.store_billingCashierAppDetail_split.load();
                            }
                        },
                        failure: function (response, options) {
                            var rsp = Ext.decode(response.responseText);
    ...
    orderProduct_split: function (me) {
        ...
        return desktop.createWindow({
            ...
            defaultFocus: 'order_qty_orderProduct_split',
            items: [{
                xtype: 'form',
    ...
    loadDataAnywherePrinter: function (me) {
        ...
        return desktop.createWindow({
            ...
            items: [{
                xtype: 'panel',
                id: 'billingCashierApp_dataViewAnywherePrinter_area',
                border: 0,
                layout: 'fit',
                bodyStyle: 'background:url(' + appUrl + 'assets/desktop/wallpapers/wall_preferences.jpg) center center;',
                items: [{
                    ...
                    itemSelector: 'div.ux-product-list',
                    overItemCls: 'product-list-over',
                    id: 'billingCashierApp_dataViewAnywherePrinter',
    ...
    customerPopup: function (me) {
        ...
        var phpJs = theApp.getHelper('phpJs');
        var store_masterCustomer_payBilling = theApp.getStore('store_masterCustomer_payBilling', false);
        if (store_masterCustomer_payBilling == false) {
            store_masterCustomer_payBilling = theApp.copyStore('master_pos', 'store_masterCustomer', 'store_masterCustomer_payBilling');
        }
        store_masterCustomer_payBilling.proxy.extraParams.limit = 999999;
        store_masterCustomer_payBilling.proxy.extraParams.is_dropdown = 0;
        store_masterCustomer_payBilling.proxy.extraParams.is_active = 1;
        store_masterCustomer_payBilling.proxy.extraParams.show_all_text = 0;
        store_masterCustomer_payBilling.proxy.extraParams.show_choose_text = 0;
        store_masterCustomer_payBilling.proxy.extraParams.keywords = '';
        return desktop.createWindow({
            id: me.id + '_masterCustomer',
            title: 'Data Customer',
            width: 700,
            height: 400,
            iconCls: 'icon-users',
            ...
            items: [{
                ...
                store: store_masterCustomer_payBilling,
                scroll: true,
                columns: [{
                    xtype: 'gridcolumn',
                    dataIndex: 'id',
                ...
                listeners: {
                    itemclick: function (view, rec, item, index, eventObj) {
                        ...
                        if (rec.data.customer_contact_person != '') {
                            ...
                            form.findField('customer_name').setValue(rec.data.customer_name);
                        }
                        me.doClose(me.id + '_masterCustomer');
                    },
                }
            }],
            buttons: [{
            ...
            listeners: {
                show: function () {
                    store_masterCustomer_payBilling.load();
                }
            }
        });
    },
    marketingPopup: function (me) {
        ...
        var Titletext = 'Data Customer';
        var phpJs = theApp.getHelper('phpJs');
        var store_masterSales_payBilling = theApp.getStore('store_masterSales_payBilling', false);
        if (store_masterSales_payBilling == false) {
            store_masterSales_payBilling = theApp.copyStore('master_pos', 'store_masterSales', 'store_masterSales_payBilling');
        }
        store_masterSales_payBilling.proxy.extraParams.limit = 999999;
        store_masterSales_payBilling.proxy.extraParams.show_all_text = 0;
        store_masterSales_payBilling.proxy.extraParams.show_valid_date = 1;
        store_masterSales_payBilling.proxy.extraParams.is_dropdown = 0;
        store_masterSales_payBilling.proxy.extraParams.is_active = 1;
        store_masterSales_payBilling.proxy.extraParams.sales_type = 0;
        store_masterSales_payBilling.proxy.extraParams.keywords = '';
        return desktop.createWindow({
            id: me.id + '_masterSales',
            ...
            items: [{
                ...
                store: store_masterSales_payBilling,
                scroll: true,
                columns: [{
                    xtype: 'gridcolumn',
                    dataIndex: 'id',
                ...
                listeners: {
                    itemclick: function (view, rec, item, index, eventObj) {
                        ...
                        form.findField('sales_name').setValue(rec.data.sales_name + '/' + rec.data.sales_company);
            ...
            listeners: {
                show: function () {
                    store_masterSales_payBilling.load();
                }
            }
        });
    },
