...
Ext.define('ExtApp.modules.billing.model.model_dashboardCustomer', {
    extend: 'Ext.data.Model',
    alias: 'model_dashboardCustomer',
    fields: [{
...
Ext.define("ExtApp.modules.billing.view.dashboard", {
    ...
    processCustomerData: function (me) {
        var theApp = me.app;
        var store_dashboard_dataBilling = theApp.getStore('store_billingCashier_paidBilling', false);
        if(store_dashboard_dataBilling == false){
            store_dashboard_dataBilling = theApp.copyStore('billing', 'store_dataBilling', 'sotre_billingCashier_paidBilling')
        }
        console.log(store_dashboard_dataBilling);
    }
});