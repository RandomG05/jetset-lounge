...
Ext.define("ExtApp.modules.billing.view.dashboard", {
    openWindow: function (me) {
        ...
        var store_dashboard_categoryPurchase = Ext.create('Ext.data.JsonStore', {
            fields: ['category_name', 'total_qty'],
            data: [
                {category_name: 'Catering', total_qty: '34'},
                {category_name: 'Dessert', total_qty: '13'},
                {category_name: 'Florist', total_qty: '20'},
                {category_name: 'Others', total_qty: '72'},
                {category_name: 'Pastry', total_qty: '52'}
            ]
        });
                    ...
                    items: [{
                        ...
                        series: [{
                            ...
                            tips: {
                                ...
                                width: 100,
                                renderer: function(storeItem, item) {
                                    this.setTitle(storeItem.get('category_name')+':'+storeItem.get('total_qty'));
                                }
                            }
                        }]
                    }]
