...
(1, 'Setup Aplikasi', 'dev@SPOS.id', 'v.1.0', '', 'systems', 'setupAplikasiFree', 1, '1. Master Aplikasi>Setup Aplikasi', 1, 'icon-cog', 'icon-cog', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Setup Aplikasi', 1000, 'icon-cog', '', 0, 'icon-cog', '', 1, 'icon-cog', '', 0, 'icon-cog', '', 'administrator', '2019-03-06 18:52:11', 'administrator', '2019-03-07 10:00:00', 1, 0),
(2, 'Client Info', 'dev@SPOS.id', 'v.1.0.0', 'Client Info', 'systems', 'clientInfo', 0, '1. Master Aplikasi>Client Info', 1, 'icon-home', 'icon-home', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Client Info', 1101, 'icon-home', '', 0, 'icon-home', '', 1, 'icon-home', '', 1, 'icon-home', '', 'administrator', '2019-03-06 17:47:08', 'administrator', '2019-03-06 17:47:08', 1, 0),
(3, 'Client Unit', 'dev@SPOS.id', 'v.1.0', '', 'systems', 'DataClientUnit', 1, '1. Master Aplikasi>Client Unit', 1, 'icon-building', 'icon-building', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Client Unit', 1102, 'icon-building', '', 0, 'icon-building', '', 1, 'icon-building', '', 1, 'icon-building', '', 'administrator', '2019-03-06 18:52:10', 'administrator', '2019-03-07 10:00:00', 1, 0),
(4, 'Data Structure', 'dev@SPOS.id', 'v.1.0', '', 'systems', 'DataStructure', 1, '1. Master Aplikasi>Data Structure', 1, 'icon-building', 'icon-building', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Data Structure', 1103, 'icon-building', '', 0, 'icon-building', '', 1, 'icon-building', '', 1, 'icon-building', '', 'administrator', '2019-03-06 18:52:11', 'administrator', '2019-03-07 10:00:00', 1, 0),
(5, 'Role Manager', 'dev@SPOS.id', 'v.1.2', 'Role Manager', 'systems', 'Roles', 1, '1. Master Aplikasi>Role Manager', 1, 'icon-role-modules', 'icon-role-modules', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Role Manager', 1201, 'icon-role-modules', '', 0, 'icon-role-modules', '', 1, 'icon-role-modules', '', 1, 'icon-role-modules', '', 'administrator', '2019-03-06 18:52:15', 'administrator', '2019-03-07 10:00:00', 1, 0),
(6, 'Data User', 'dev@SPOS.id', 'v.1.0', '', 'systems', 'UserData', 1, '1. Master Aplikasi>Data User', 1, 'icon-user-data', 'icon-user-data', '', '', 1, 0, 1, 0, '1. Master Aplikasi>Data User', 1203, 'icon-user-data', '', 0, 'icon-user-data', '', 1, 'icon-user-data', '', 0, 'icon-user-data', '', 'administrator', '2019-03-06 18:52:11', 'administrator', '2019-03-07 10:00:00', 1, 0),
(7, 'User Profile', 'dev@SPOS.id', 'v.1.0', '', 'systems', 'UserProfile', 1, '1. Master Aplikasi>User Profile', 1, 'user', 'user', '', '', 1, 0, 1, 1, '1. Master Aplikasi>User Profile', 1301, 'user', '', 1, 'user', '', 1, 'user', '', 1, 'user', '', 'administrator', '2019-03-06 18:52:17', 'administrator', '2019-03-07 10:00:00', 1, 0),
(8, 'Desktop Shortcuts', 'dev@SPOS.id', 'v.1.0', 'Shortcuts Manager to Desktop', 'systems', 'DesktopShortcuts', 1, '1. Master Aplikasi>Desktop Shortcuts', 1, 'icon-preferences', 'icon-preferences', '', '', 1, 0, 1, 1, '1. Master Aplikasi>Desktop Shortcuts', 1302, 'icon-preferences', '', 1, 'icon-preferences', '', 1, 'icon-preferences', '', 1, 'icon-preferences', '', 'administrator', '2019-03-06 18:52:12', 'administrator', '2019-03-07 10:00:00', 1, 0),
...
(10, 'Refresh Aplikasi', 'dev@SPOS.id', 'v.1.0.0', '', 'systems', 'refreshModule', 0, 'Refresh Aplikasi', 1, 'icon-refresh', 'icon-refresh', '', '', 1, 0, 0, 0, 'Refresh Aplikasi', 1304, 'icon-refresh', '', 0, 'icon-refresh', '', 1, 'icon-refresh', '', 0, 'icon-refresh', '', 'administrator', '2019-03-07 01:00:19', 'administrator', '2019-03-07 01:00:19', 1, 0),
(11, 'Lock Screen', 'dev@SPOS.id', 'v.1.0.0', 'User Lock Screen', 'systems', 'lockScreen', 0, 'LockScreen', 1, 'icon-grid', 'icon-grid', '', '', 1, 1, 0, 0, 'LockScreen', 1305, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-02-16 11:40:20', 'administrator', '2019-03-07 10:00:00', 1, 0),
(12, 'Logout', 'dev@SPOS.id', 'v.1.0.0', 'Just Logout Module', 'systems', 'logoutModule', 0, 'Logout', 1, 'icon-grid', 'icon-grid', '', '', 1, 1, 0, 0, 'Logout', 1306, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-02-16 11:36:16', 'administrator', '2019-03-07 01:06:35', 1, 0),
(13, 'SPOS Update', 'dev@SPOS.id', 'v.1.0.0', 'SPOS Update', 'systems', 'weposUpdate', 0, '1. Master Aplikasi>SPOS Update', 1, 'icon-sync', 'icon-grid', '', '', 1, 0, 1, 0, '1. Master Aplikasi>SPOS Update', 1401, 'icon-sync', '', 0, 'icon-sync', '', 1, 'icon-sync', '', 1, 'icon-sync', '', 'administrator', '2019-03-06 18:00:58', 'administrator', '2019-03-06 18:00:58', 1, 0),
(14, 'Notifikasi Sistem', 'dev@SPOS.id', 'v.1.0.0', 'Notifikasi Sistem', 'systems', 'systemNotify', 0, 'Notifikasi Sistem', 1, 'icon-info', 'icon-info', '', '', 1, 1, 0, 0, 'Notifikasi Sistem', 1402, 'icon-info', '', 0, 'icon-info', '', 0, 'icon-info', '', 0, 'icon-info', '', 'administrator', '2019-03-06 18:00:58', 'administrator', '2019-03-06 18:00:58', 1, 0),
(15, 'Menu Category', 'dev@SPOS.id', 'v.1.0', '', 'master_pos', 'productCategory', 0, '2. Master POS>Menu Category', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Menu Category', 2101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 03:26:07', 'administrator', '2019-03-07 10:00:00', 1, 0),
(16, 'Master Menu & Package', 'dev@SPOS.id', 'v.1.0', 'Master Menu & Package', 'master_pos', 'masterProduct', 0, '2. Master POS>Master Menu', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Menu', 2102, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 03:24:38', 'administrator', '2019-03-07 10:00:00', 1, 0),
(19, 'Master Warehouse', 'dev@SPOS.id', 'v.1.0.0', 'Master Warehouse', 'master_pos', 'masterStoreHouse', 0, '2. Master POS>Master Warehouse', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Warehouse', 2201, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 13:24:56', 'administrator', '2019-03-07 06:05:16', 1, 0),
(20, 'Master Unit', 'dev@SPOS.id', 'v.1.0.0', 'Master Unit', 'master_pos', 'masterUnit', 0, '2. Master POS>Master Unit', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Unit', 2202, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 13:25:13', 'administrator', '2019-03-07 08:15:29', 1, 0),
(21, 'Master Supplier', 'dev@SPOS.id', 'v.1.0.0', 'Master Supplier', 'master_pos', 'masterSupplier', 0, '2. Master POS>Supplier', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Supplier', 2203, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 13:25:04', 'administrator', '2019-03-07 06:04:34', 1, 0),
(22, 'Item Category', 'dev@SPOS.id', 'v.1.0.0', 'Item Category', 'master_pos', 'itemCategory', 0, '2. Master POS>Item Category', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Item Category', 2210, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 10:36:29', 'administrator', '2019-03-07 06:31:54', 1, 0),
...
(24, 'Master Item', 'dev@SPOS.id', 'v.1.0.0', 'Data Item', 'master_pos', 'masterItemCafe', 0, '2. Master POS>Master Item', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Item', 2230, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 00:04:34', 'administrator', '2019-03-07 00:04:34', 1, 0),
(25, 'Discount Planner', 'dev@SPOS.id', 'v.1.0', 'Planning All discount Menu', 'master_pos', 'discountPlannerFree', 0, '2. Master POS>Discount Planner', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Discount Planner', 2301, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 03:26:01', 'administrator', '2019-03-07 10:00:00', 1, 0),
(26, 'Printer Manager', 'dev@SPOS.id', 'v.1.0', 'Printer Manager', 'master_pos', 'masterPrinter', 0, '2. Master POS>Printer Manager', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Printer Manager', 2302, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 13:24:50', 'administrator', '2019-03-07 06:06:25', 1, 0),
(28, 'Master Bank', 'dev@SPOS.id', 'v.1.0.0', 'Master Bank', 'master_pos', 'masterBank', 0, '2. Master POS>Master Bank', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Bank', 2304, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 13:24:53', 'administrator', '2019-03-07 06:05:03', 1, 0),
(31, 'Master Floor Plan', 'dev@SPOS.id', 'v.1.0', '', 'master_pos', 'masterFloorplan', 0, '2. Master POS>Master Floor Plan', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Floor Plan', 2307, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 03:26:51', 'administrator', '2019-03-07 10:00:00', 1, 0),
(32, 'Master Room', 'dev@SPOS.id', 'v.1.0', 'Master Room', 'master_pos', 'masterRoom', 0, '2. Master POS>Master Room', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Room', 2308, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 03:24:38', 'administrator', '2019-03-07 10:00:00', 1, 0),
(33, 'Master Table', 'dev@SPOS.id', 'v.1.0.0', '', 'master_pos', 'masterTable', 0, '2. Master POS>Master Table', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Master Table', 2309, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 03:26:54', 'administrator', '2019-03-07 10:00:00', 1, 0),
(34, 'Table Inventory', 'dev@SPOS.id', 'v.1.0.0', '', 'master_pos', 'tableInventory', 0, '2. Master POS>Table Inventory', 2, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>Table Inventory', 2310, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 03:26:59', 'administrator', '2019-03-07 10:00:00', 1, 0),
(35, 'Warehouse Access', 'dev@SPOS.id', 'v.1.0.0', 'Warehouse Access', 'master_pos', 'warehouseAccess', 0, '2. Master POS>User Access>Warehouse Access', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>User Access>Warehouse Access', 2401, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-02-27 05:23:32', 'administrator', '2019-03-07 06:02:49', 1, 0),
...
(37, 'Supervisor Access', 'dev@SPOS.id', 'v.1.0.0', 'Supervisor Access', 'master_pos', 'supervisorAccess', 0, '2. Master POS>User Access>Supervisor Access', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '2. Master POS>User Access>Supervisor Access', 2403, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-02-11 08:53:04', 'administrator', '2019-03-07 06:02:58', 1, 0),
...
(41, 'List Open Close Cashier', 'dev@SPOS.id', 'v.1.0.0', '', 'cashier', 'listOpenCloseCashier', 0, '3. Cashier & Reservation>List Open Close Cashier', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Reservation>List Open Close Cashier', 3003, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-06 17:59:55', 'administrator', '2019-03-06 17:59:55', 1, 0),
(42, 'Cashier', 'dev@SPOS.id', 'v.1.0', 'Cashier', 'cashier', 'billingCashier', 0, '3. Cashier & Reservation>Cashier', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Reservation>Cashier', 3101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 13:28:03', 'administrator', '2019-03-06 22:58:59', 1, 0),
(48, 'Cashier Receipt Setup', 'dev@SPOS.id', 'v.1.0.0', 'Cashier Receipt Setup', 'cashier', 'cashierReceiptSetup', 0, '3. Cashier & Reservation>Cashier Receipt Setup', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Reservation>Cashier Receipt Setup', 3301, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 16:13:49', 'administrator', '2019-03-06 22:59:09', 1, 0),
(51, 'Purchase Order/Pembelian', 'dev@SPOS.id', 'v.1.0.0', 'Purchase Order/Pembelian', 'purchase', 'purchaseOrder', 0, '4. Purchase & Receive>Purchase Order/Pembelian', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '4. Purchase & Receive>Purchase Order/Pembelian', 4201, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 13:27:18', 'administrator', '2019-03-07 01:07:08', 1, 0),
(52, 'Receiving List/Penerimaan Barang', 'dev@SPOS.id', 'v.1.0.0', 'Receiving List/Penerimaan Barang', 'inventory', 'receivingList', 0, '4. Purchase & Receive>Receiving List/Penerimaan Barang', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '4. Purchase & Receive>Receiving List/Penerimaan Barang', 4301, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-06 22:05:57', 'administrator', '2019-03-06 23:04:22', 1, 0),
(53, 'Daftar Stok Barang', 'dev@SPOS.id', 'v.1.0.0', 'Daftar Stok Barang', 'inventory', 'listStock', 0, '5. Inventory>Daftar Stok Barang', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '5. Inventory>Daftar Stok Barang', 5101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 16:43:42', 'administrator', '2019-03-06 23:22:20', 1, 0),
(58, 'Stock Opname', 'dev@SPOS.id', 'v.1.0.0', 'Module Stock Opname', 'inventory', 'stockOpname', 0, '5. Inventory>Stock Opname', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '5. Inventory>Stock Opname', 5401, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-06 22:06:05', 'administrator', '2019-03-06 23:22:51', 1, 0),
(77, 'Closing Sales', 'dev@SPOS.id', 'v.1.0.0', 'Closing Sales', 'audit_closing', 'closingSales', 0, '8. Closing & Audit>Closing Sales', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '8. Closing & Audit>Closing Sales', 8101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 07:43:42', 'administrator', '2019-03-07 07:43:42', 1, 0),
(78, 'Closing Purchasing', 'dev@SPOS.id', 'v.1.0.0', 'Closing Purchasing', 'audit_closing', 'closingPurchasing', 0, '8. Closing & Audit>Closing Purchasing', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '8. Closing & Audit>Closing Purchasing', 8102, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 07:47:56', 'administrator', '2019-03-07 07:51:27', 1, 0),
...
(86, 'Sales Report', 'dev@SPOS.id', 'v.1.0', 'Sales Report', 'billing', 'reportSales', 0, '6. Reports>Sales (Billing)>Sales Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Sales Report', 6101, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 11:28:24', 'administrator', '2019-03-07 03:01:16', 1, 0),
(89, 'Sales Report (Recap)', 'dev@SPOS.id', 'v.1.0.0', '', 'billing', 'reportSalesRecap', 0, '6. Reports>Sales (Billing)>Sales Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Sales Report (Recap)', 6104, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 02:30:29', 'administrator', '2019-03-07 02:38:02', 1, 0),
(90, 'Sales By Discount', 'dev@SPOS.id', 'v.1.0.0', 'Sales By Discount', 'billing', 'salesByDiscount', 0, '6. Reports>Sales (Billing)>Sales By Discount', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Sales By Discount', 6105, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 06:43:42', 'administrator', '2019-03-07 06:43:42', 1, 0),
(92, 'Sales Summary Report (SSR)', 'dev@SPOS.id', 'v.1.0.0', 'Sales Summary Report (SSR)', 'billing', 'salesSummaryReport', 0, '6. Reports>Sales (Billing)>Sales Summary Reports (SSR)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Billing)>Sales Summary Reports (SSR)', 6108, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 06:43:42', 'administrator', '2019-03-07 06:43:42', 1, 0),
...
(102, 'Sales By Menu', 'dev@SPOS.id', 'v.1.0.0', 'Sales By Menu', 'billing', 'reportSalesByMenu', 0, '6. Reports>Sales (Menu)>Sales By Menu', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Menu)>Sales By Menu', 6120, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-02-08 15:51:55', 'administrator', '2019-03-07 03:47:33', 1, 0),
(106, 'Sales Profit Report', 'dev@SPOS.id', 'v.1.0.0', '', 'billing', 'reportSalesProfit', 0, '6. Reports>Sales (Profit)>Sales Profit Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Profit)>Sales Profit Report', 6131, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 02:46:57', 'administrator', '2019-03-07 03:21:51', 1, 0),
(109, 'Sales Profit Report (Recap)', 'dev@SPOS.id', 'v.1.0.0', '', 'billing', 'reportSalesProfitRecap', 0, '6. Reports>Sales (Profit)>Sales Profit Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Profit)>Sales Profit Report (Recap)', 6134, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 02:58:17', 'administrator', '2019-03-07 03:23:59', 1, 0),
(110, 'Sales Profit By Menu', 'dev@SPOS.id', 'v.1.0.0', 'Sales Profit By Menu', 'billing', 'reportSalesProfitByMenu', 0, '6. Reports>Sales (Profit)>Sales Profit By Menu', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Profit)>Sales Profit By Menu', 6135, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-07 02:53:21', 'administrator', '2019-03-07 05:38:07', 1, 0),
(119, 'Bagi Hasil', 'dev@SPOS.id', 'v.1.0.0', 'Bagi Hasil Detail', 'billing', 'reportSalesBagiHasil', 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil', 6301, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-02-14 16:43:42', 'administrator', '2019-02-14 16:43:42', 1, 0),
(120, 'Bagi Hasil (Recap)', 'dev@SPOS.id', 'v.1.0.0', 'Bagi Hasil (Recap)', 'billing', 'reportSalesBagiHasilRecap', 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Sales (Bagi Hasil)>Bagi Hasil (Recap)', 6302, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-02-14 16:43:42', 'administrator', '2019-02-14 16:43:42', 1, 0),
(125, 'Purchase Report', 'dev@SPOS.id', 'v.1.0.0', 'Purchase Report', 'purchase', 'reportPurchase', 0, '6. Reports>Purchase/Pembelian>Purchase Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Purchase/Pembelian>Purchase Report', 6401, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-02-16 07:28:58', 'administrator', '2019-03-07 05:08:45', 1, 0),
(127, 'Purchase Report (Recap)', 'dev@SPOS.id', 'v.1.0.0', 'Purchase Report (Recap)', 'purchase', 'reportPurchaseRecap', 0, '6. Reports>Purchase/Pembelian>Purchase Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Purchase/Pembelian>Purchase Report (Recap)', 6403, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-06 23:23:40', 'administrator', '2019-03-07 05:08:25', 1, 0),
...
(129, 'Receiving Report', 'dev@SPOS.id', 'v.1.0.0', 'Receiving Report', 'inventory', 'reportReceiving', 0, '6. Reports>Receiving (In)>Receiving Report', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Receiving (In)>Receiving Report', 6501, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 0, 'icon-grid', '', 'administrator', '2019-03-06 23:31:50', 'administrator', '2019-03-07 05:00:32', 1, 0),
(132, 'Receiving Report (Recap)', 'dev@SPOS.id', 'v.1.0.0', 'Receiving Report (Recap)', 'inventory', 'reportReceivingRecap', 0, '6. Reports>Receiving (In)>Receiving Report (Recap)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Receiving (In)>Receiving Report (Recap)', 6504, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 01:57:19', 'administrator', '2019-03-07 05:01:16', 1, 0),
(145, 'Monitoring Stock (Actual)', 'dev@SPOS.id', 'v.1.0.0', 'Monitoring Stock (Actual)', 'inventory', 'reportMonitoringStock', 0, '6. Reports>Warehouse>Monitoring Stock (Actual)', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Warehouse>Monitoring Stock (Actual)', 6642, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-02-11 09:44:12', 'administrator', '2019-03-07 10:45:36', 1, 0),
(146, 'Kartu Stok', 'dev@SPOS.id', 'v.1.0.0', 'Kartu Stok', 'inventory', 'kartuStok', 0, '6. Reports>Warehouse>Kartu Stock', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '6. Reports>Warehouse>Kartu Stock', 6643, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-03-07 16:43:42', 'administrator', '2019-03-07 10:46:03', 1, 0),
(169, 'Pembayaran PPOB', 'dev@SPOS.id', 'v.1.0.0', 'Pembayaran PPOB', 'cashier', 'ppob', 0, '3. Cashier & Reservation>Pembayaran PPOB', 1, 'icon-grid', 'icon-grid', '', '', 1, 0, 1, 0, '3. Cashier & Reservation>Pembayaran PPOB', 3401, 'icon-grid', '', 0, 'icon-grid', '', 1, 'icon-grid', '', 1, 'icon-grid', '', 'administrator', '2019-04-09 01:25:57', 'administrator', '2019-04-09 10:49:57', 0, 0);
...
(15, 'ipserver_management_systems', 'https://SPOS.id', NULL, '2019-02-11 13:00:00', 'administrator', NULL, NULL, 1, 0),
...
(1, 'administrator', 'e10adc3949ba59abbe56e057f20f883e', 1, 'Super', 'Admin', 'contact@SPOS.id', '6281222549676', '1231239990111', 'Bandung - West Java - Indonesia', 1, 1, '0', 'administrator', '2019-03-07 01:00:00', 'administrator', '2019-03-07 01:00:00', 1, 0, '9999'),
(2, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 2, 'Admin', 'SPOS', 'contact@SPOS.id', '', '', '', 1, 2, '0', 'administrator', '2019-03-07 01:00:00', 'administrator', '2019-03-07 01:00:00', 1, 0, '1234'),
(3, 'kasir', 'e10adc3949ba59abbe56e057f20f883e', 5, 'Kasir', 'SPOS', 'contact@SPOS.id', NULL, NULL, NULL, 1, 7, '0', 'administrator', '2019-03-07 01:00:00', 'administrator', '2019-03-07 01:00:00', 1, 0, '7890'),
(4, 'purchasing', 'e10adc3949ba59abbe56e057f20f883e', 3, 'Purchasing', 'SPOS', 'contact@SPOS.id', '', '', '', 1, 11, NULL, 'admin', '2019-03-07 10:17:05', 'admin', '2019-03-07 10:17:18', 1, 0, '8165');
...
(1, 'C18080001', 'SPOS Customer Test', 'SPOS', 'Bandung', '022', NULL, 'support@SPOS.id', 'admin', '2019-03-07 15:16:28', 'admin', '2019-03-07 15:16:28', 1, 0, 'ok', '', 'MERCHANT', 1, NULL, 0, NULL, 0);
